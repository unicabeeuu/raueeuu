<?php
    ...
    //1000319642 CicloVI | 1014859175 Noveno | 1092856048 Tercero
    ...
    while($row = $resultado->fetch_assoc()){
        ...
        if($idgra == 6 || $idgra == 10 || $idgra == 12 || $idgra == 16 || $idgra == 18) {
            if($idgra == 18) {
            ...
            if($idgra == 17) {
                $longitud_f = $longitud3;
                $pagos_f = $pagos3;
            }
            else {
                $longitud_f = $longitud1;
                $pagos_f = $pagos1;
            }
            for($i=0; $i<$longitud_f; $i++) {
                $content = '<html>';
                ...
                $content1 .= '<div>';
                                ...
                                if ($ct > 1) {
                                    ...
                                    while($rowo1 = $res_otros1->fetch_assoc()){
                                        $content1 .= '<tr>';
                                            ...
                                            $content1 .= '<td class="tdborde">'.$rowo1['grado_ra'].'</td>';
                                            if($idgra == 17) {
                                                $content1 .= '<td class="tdborde">'.$des3[$i].'</td>';
                                                $content1 .= '<td class="tdborde">'.$rowo1['n_documento'].'_'.$fanio.'_'.$pagos3[$i].'</td>';
                                            }
                                            else {
                                                $content1 .= '<td class="tdborde">'.$des1[$i].'</td>';
                                                $content1 .= '<td class="tdborde">'.$rowo1['n_documento'].'_'.$fanio.'_'.$pagos1[$i].'</td>';
                                            }
                                    ...
                                    $content1 .= '<tr>';
                                        ...
                                        if($idgra == 17) {
                                            $content1 .= '<td class="tdborde">'.$des3[$i].'</td>';
                                            $content1 .= '<td class="tdborde">'.$row['n_documento'].'_'.$fanio.'_'.$pagos3[$i].'</td>';
                                        }
                                        else {
                                            $content1 .= '<td class="tdborde">'.$des1[$i].'</td>';
                                            $content1 .= '<td class="tdborde">'.$row['n_documento'].'_'.$fanio.'_'.$pagos1[$i].'</td>';
                                        }
                    ...
                    //$content1 .= '<p id="lblconvenciones" class="cpurple">* Primer pago (pp) => Matrícula (m) {'.$row['matricula'].'} + pensión mes 1 (pm1) {'.$row['pension'].'} + otros cobros periódicos (ocp) {'.$row['ocp'].'} + poliza {'.$row['poliza'].'}.</p>';
                    if($pagos_f[$i] == "pp") {
                        $content1 .= '<p id="lblconvenciones" class="cpurple">* Primer pago (pp) => Matrícula (m) {'.$row['matricula'].'} + pensión mes 1 (pm1) {'.$row['pension_final'].'} + otros cobros periódicos (ocp) {'.$row['ocp'].'} + poliza {'.$row['poliza'].'}.</p>';
                    }
                $content1 .= '</div>';
