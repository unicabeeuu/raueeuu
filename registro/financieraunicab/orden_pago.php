<?php
    ...
    //https://unicab.org/registro/financieraunicab/orden_pago.php?selgra1=10&idest=1014859175
    ...
    //$mpdf->SetDisplayMode(90); //Esto sería el 90 por ciento del tamaño de la hoja
    ...
    while($row = $resultado->fetch_assoc()){
        ...
        for($i=0; $i<$longitud_f; $i++) {
            ...
            $content1 .= '<div>';
                ...
                $content1 .= '</div>';
                $pago_incremento = $number + round($number * 0.03, 0);
                ...
                if($ct > 1) {
                    if($pagos_f[$i] == "pp") {
                        ...
                        $content1 .= '<p id="lblconvenciones" class="cpurple">* Fecha pago oportuno '.$fanio."/".$mes."/10".'. Incremento del 3% después de ésta fecha. Pago con incremento $'.$pago_incremento.'</p>';                        
                    }
                }
                else {
                    if($pagos_f[$i] == "pp") {
