...
<head>
    <title></title>
    <meta http-equiv="Refresh" content="0; URL=https://unicab.org/registro/adminunicab/">
</head>
<body>
 ...
 */
define("DB_USER", 'superimpacto');
define("DB_PASSWORD", 'V~,Xsdt+{8TR');
define("DB_NAME", 'admin_unicab');
