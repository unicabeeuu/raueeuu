<?php
    ...
    if (isset($_SESSION['unisuper'])) {
        ...
        $peticion= "SELECT e.nombres, e.apellidos, e.genero, td.tipo_documento, e.n_documento, e.expedicion, e.ciudad, g.grado, g.id, 
            ...
            WHERE m.id_estudiante=".$id_estudiante." and m.idMatricula=".$id_matriculaActual." AND date_format(m.fecha_ingreso, '%Y') = $aant";
        //echo $peticion;
...
<?php
	...
	$sql_ct_notas = "SELECT COUNT(1) ct FROM notas_bck_20231125 WHERE id_estudiante = $id_estudiante AND id_grado = ".$id_gradoActual;
	//echo $sql_ct_notas;
	...
	//La siguiene línea se habilita para buscar notas en el historial
    //$ct_tabla_notas = 0;
		...
		<!--CERTIFICADO  ********************************** AQUI VOY ***** comparar con reporte_notas_getdat1.php -->
		    <div class="panel panel-default">
  				<div class="panel-body" align="center">
                    ...
                    <?php 
						if ($firmas=="SI") {
							//echo "<img class='img-responsive' width='70%' src='../images/firma_certficados.png'>";
							echo "<img class='img-responsive' width='800' height='190' src='../images/firma_certificados.JPG'>";
						}else{
							echo "<img class='img-responsive' width='70%' src='../images/firma_certificados_liliana_sf.png'>";
						}
					?>
					<hr>
					<p id="pie-pagina" align="center">
					Calle 13ª N° 16-60 Sogamoso – Boyacá Tel. 608 7752309 Cel. 300 815 6531 - 315 696 5291<br>
					www.unicab.org
					</p>
 				</div>
			</div>
			<!--CERTIFICADO-->
			<div align="center">
				<form action="php/Registro-certificado_aanterior.php" method="POST" target="_blank">
					...
					<input type="hidden" name="aant" value="<?php echo $aant;?>">
					<?php  
					    if($ct == 0) {
