...
if (isset($_SESSION['unisuper']) || isset($_SESSION['uniprofe'])) {
	...
	$datos = array();
	$keys = ['response','celular'];
	$i = 0;
	
	$curl = curl_init();
	
	//Se hace la consulta de los números de celular a enviar los whatsapp
	//$sql_num = "SELECT DISTINCT telefono_acudiente_1 FROM tbl_prueba WHERE texto = 'NA'";
	$sql_num = "SELECT DISTINCT p.telefono_acudiente_1  
	FROM tbl_prueba p, estudiantes e, matricula m, grados g 
	WHERE (p.telefono_acudiente_1 = e.telefono_acudiente_1 OR p.telefono_acudiente_1 = e.telefono_acudiente_2) 
	AND e.id = m.id_estudiante AND m.id_grado = g.id AND g.id = $idgra";
    
    //$sql_num = "SELECT DISTINCT telefono_acudiente_1 FROM tbl_prueba WHERE telefono_acudiente_1 = '3192997229'";
	...
	while ($fila_num = mysqli_fetch_array($res_num)){
		...
		//echo $fila_num['telefono_acudiente_1'];
        if($destino == $fila_num['telefono_acudiente_1']) {
            ...
            $valores = [$response,$fila_num['telefono_acudiente_1']];
					...
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						...
						<div class="form-body">
							<?php
								...
								echo "CURLOPT_POSTFIELDS: ".$CURLOPT_POSTFIELDS."<br>";
