<?php
	...
	$i = 1;
	$query1 = "SELECT * FROM tbl_stickers_virtuales WHERE grado = ".$idgra." AND a = ".$anio." AND id IN ($ids)";
	//echo $query1;	
    ...
    $content .= 'table {border-collapse: collapse; border-spacing: 0; page-break-inside: avoid;}';
	...
	if ($controlRegistroImpar == 1) {
		...
		$content .= '<tbody style="page-break-inside: avoid; break-inside: avoid; -webkit-column-break-inside: avoid;">';
		$content .= '<tr><!-- 1 -->
					<td class="small1 bl bt"></td>
					<td class="negrilla bt t1" colspan="4">COLEGIO VIRTUAL UNICAB</td>
					<td class="medium1 bt br"></td>
