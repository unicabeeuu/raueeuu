...
if (isset($_SESSION['unisuper']) || isset($_SESSION['uniprofe'])) {
	...
	$peticion="SELECT * FROM tbl_asistencias";
           		...
           		<div class="forms">
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						<div class="form-title">
							<h4>List of meeting attendance for parents:</h4>
						</div>
						<div class="form-body">  
					    	<table id="listEstudiantes" class="display" style="width:100%">
						        ...
						        <tbody>
						        	...
						        	while ($fila = mysqli_fetch_array($resultado)){
										echo"<tr><td>".$fila['n_documento']."</td>
    						        		<td>".$fila['nombre']."</td>
    						        		<td>".$fila['grado']."</td>
    						        		<td>".$fila['nombre_a']."</td>
											<td>".$fila['celular_a']."</td>
    						        		<td>".$fila['fecha']."</td>
    						        		</tr>";
						        	}
						        	?>
