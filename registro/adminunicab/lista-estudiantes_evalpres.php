...
if (isset($_SESSION['unisuper']) || isset($_SESSION['uniprofe'])) {
    ...
    CASE WHEN e.id <= 2380 THEN 'Antiguo' ELSE 'Nuevo' END tipo_estudiante 
	FROM estudiantes e, tbl_respuestas r, grados g 
    WHERE e.n_documento = r.identificacion AND r.id_grado = g.id 
    AND r.a = 2023 
