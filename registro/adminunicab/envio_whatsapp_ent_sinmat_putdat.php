...
if (isset($_SESSION['unisuper']) || isset($_SESSION['uniprofe'])) {
    ...
    //Se consulta la cantidad de entrevistas sin matricular
    $sql_ent = "SELECT COUNT(1) ct FROM 
    (SELECT DISTINCT en.documento_est, pm.nombre_a, pm.celular_a, '0' telefono_acudiente_1, pm.nombres_est, pm.apellidos_est, 'NA' n_matricula, 'NA' estado, LENGTH(pm.celular_a) 
    FROM tbl_entrevistas en, tbl_pre_matricula pm 
    WHERE en.documento_est = pm.documento_est 
    AND en.id >= 1892 AND LENGTH(pm.celular_a) = 10 AND pm.entrevista = 'SI' 
    ...
    WHERE en.documento_est = pm.documento_est AND en.documento_est = e.n_documento AND e.id = m.id_estudiante
    AND en.id >= 1892 AND m.n_matricula like '%2023%' AND m.estado = 'pre_solicitud')) a";
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('input[name="rdentre"]').prop('checked', false);
        $("#txtident").val("0");
    ...
    function validar_datos() {
        ...
        if(control == 0) {
            ...
            if(ident != 0) {
                ...
                alert("Debe seleccionar entrevistas sin proceso de matrícula");
            }
        }
        
    }
    
    function marcarident(e) {
        //alert(e);
        $("#txtident").val(e);
    }
           	...
           	<div id="page-wrapper">
				<div class="forms">
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						...
						<div class="form-body">
							<form action="envio_whatsapp_ent_sinmat_putdat1.php" method="POST" id="form" name="form" enctype="multipart/form-data" target="_blank">
								...
								<div class="form-group"> 
									<label for="textoI" id="lbltextoI">Entrevistas sin proceso de matrícula</label> 
									<table border="1px" style="text-align: center;">
									    ...
									    <tbody>
									        <?php
									            $cadena = "";
									            while($row_ant = $res_ent->fetch_assoc()) {
                                            	    $cadena = $cadena."<tr>
                                                        <td>1</td>
                                                        <td>Entrevistas sin proceso de matrícula</td>
                                                        <td>".$row_ant['ct']."</td>
                                                        <td style='text-align: center;'><input type='radio' id='rd1' name='rdentre' class='chk' value='1' onchange='marcarident(this.value);'></td>
                                                        </tr>";
                                            	    echo $cadena;
                                            	    $cadena = "";
                                            	}
