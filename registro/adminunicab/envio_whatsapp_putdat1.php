...
if (isset($_SESSION['unisuper']) || isset($_SESSION['uniprofe'])) {
	...
	$sql_num = "SELECT e.telefono_acudiente_1, e.telefono_acudiente_2, e.acudiente_1  
    ...
    AND e.id < 2380 AND m.fecha_ingreso >= '2022-12-01') AND g.id = $idgra 
    ORDER BY e.telefono_acudiente_1";
    
    /*$sql_num = "SELECT c2 telefono_acudiente_1, c1 nombres, c1 apellidos 
    FROM tbl_temp ";*/
    /*$sql_num = "SELECT * FROM estudiantes WHERE n_documento IN ('999999', '9397454')";*/
