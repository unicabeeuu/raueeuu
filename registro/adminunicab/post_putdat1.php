				...
				<div class="forms">
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						...
						<div class="form-body">
						    ...
						    <p>The blog will be published after review of the text, image and supplementary elements.</p><br>
						    <p>Remember that if you checked the option: Supplementary text, images, videos or links; you must send that information to
						    ...
						    <ul>
						        <li>Title</li>
						        <li>Id</li>
						        <li>Supplementary text</li>
						        <li>Supplementary images</li>
						        <li>Supplementary videos</li>
						        <li>Supplementary links</li>
						    </ul>
						    
							<br><p>The email must clearly indicate the order in which the supplementary elements should be displayed.</p>
						</div>
