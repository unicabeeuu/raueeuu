<?php
	...
	set_time_limit(300);
	//https://unicab.org/registro/adminunicab/pazsalvo_est_getdat1.php?idgra=3&anio=2021
	...
	FROM tbl_pazysalvos c, tbl_estudiantes e, tbl_grados g 
	WHERE c.id_estudiante = e.id AND c.id_grado = g.id  
