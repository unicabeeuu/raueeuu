...
if (isset($_SESSION['unisuper']) || isset($_SESSION['uniprofe'])) {
    ...
    $sql_n = "SELECT DISTINCT e.*, r.id_grado, g.grado, r.estado, 
	d.DSA, d.DA, d.DM, d.DB 
    FROM estudiantes_eval_admision e, tbl_respuestas r, grados g, tbl_desemp_pres d 
