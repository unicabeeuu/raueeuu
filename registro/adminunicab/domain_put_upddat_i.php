...
<script>
	...
	$(function() {
		...
		$("#adjunto").change(function () {
			...
			$.ajax({
				type:"POST",
				url:"../docenteunicab/updreg/buscar_img_domain_i.php",
				data:"img=" + img,
				success:function(r) {
					var ct_img = r;
					//alert(ct_img);
	...
	function consultar_palabras() {//data:"idgra=" + idgra + "&idpen=" + idpen,                    
		$.ajax({
			type:"POST",
			url:"../docenteunicab/updreg/domain_put_getdat_i.php",
			success:function(r) {
				//alert(r);
				$("#divtabla").html(r);
			}
	...
	function guardar() {
		...
		$.ajax({
			type:"POST",
			url:"../docenteunicab/updreg/domain_put_putdat_i.php",
			data: formData,
			processData: false,
			contentType: false,
			success:function(r) {
	...
	function modificar() {
		...
		$.ajax({
			type:"POST",
			url:"../docenteunicab/updreg/domain_put_pal_upddat_i.php",
			data: formData,
			processData: false,
			contentType: false,
			success:function(r) {
