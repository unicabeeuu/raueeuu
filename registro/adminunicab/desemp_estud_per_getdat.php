...
<!--//Metis Menu -->
    ...
    <script>
        ...
        function consultar_desemp() {
            ...
            $.ajax({
        		type:"POST",
        		url:"../docenteunicab/updreg/desemp_estud_per.php",
        ...
        function consultar_desemp1() {
            ...
            $.ajax({
        		type:"POST",
        		url:"../docenteunicab/updreg/desemp_estud_per1.php",
        		data:"per=" + $("#selper1").val() + "&idgra=" + $("#selgra1").val() + "&selgrupo=" + $("#selgrupo").val(),
        		success:function(r) {
        		    //alert(r);
        			$("#divtabla1").html(r);
        ...
        function consultar_desemp2() {
            ...
            $.ajax({
        		type:"POST",
        		url:"../docenteunicab/updreg/desemp_estud_per2.php",
        		data:"per=" + $("#selper1").val() + "&idgra=" + $("#selgra1").val() + "&selgrupo=" + $("#selgrupo").val(),
        		success:function(r) {
        		    //alert(r);
        			$("#divtabla2").html(r);
        ...
        function consultar_desemp3() {
            ...
            $.ajax({
        		type:"POST",
        		url:"../docenteunicab/updreg/desemp_estud_per3.php",
        		data:"per=" + $("#selper1").val() + "&idgra=" + $("#selgra1").val() + "&selgrupo=" + $("#selgrupo").val(),
        		success:function(r) {
        		    //alert(r);
        			$("#divtabla3").html(r);
        ...
        function consultar_desemp4() {
            ...
            $.ajax({
        		type:"POST",
        		url:"../docenteunicab/updreg/desemp_estud_per4.php",
        		data:"per=" + $("#selper1").val() + "&idgra=" + $("#selgra1").val() + "&selgrupo=" + $("#selgrupo").val(),
        		success:function(r) {
        		    //alert(r);
        			$("#divtabla4").html(r);
        ...
        function consultar_desemp5() {
            ...
            $.ajax({
        		type:"POST",
        		url:"../docenteunicab/updreg/desemp_estud_per5.php",
        		data:"per=" + $("#selper1").val() + "&idgra=" + $("#selgra1").val() + "&selgrupo=" + $("#selgrupo").val(),
        		success:function(r) {
        		    //alert(r);
        			$("#divtabla5").html(r);
        ...
        function consultar_desemp6() {
            ...
            $.ajax({
        		type:"POST",
        		url:"../docenteunicab/updreg/desemp_estud_per6.php",
        		data:"per=" + $("#selper1").val() + "&idgra=" + $("#selgra1").val() + "&selgrupo=" + $("#selgrupo").val(),
        		success:function(r) {
        		    //alert(r);
        			$("#divtabla6").html(r);
        ...
        function consultar_desemp7() {
            ...
            $.ajax({
        		type:"POST",
        		url:"../docenteunicab/updreg/desemp_estud_per7.php",
        		data:"per=" + $("#selper1").val() + "&idgra=" + $("#selgra1").val() + "&selgrupo=" + $("#selgrupo").val(),
        		success:function(r) {
        		    //alert(r);
        			$("#divtabla7").html(r);
