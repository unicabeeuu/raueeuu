						        ...
						        <tbody>
						        	<?php 
							        	while ($fila = mysqli_fetch_array($resultado)){
							        		...
							        		<td>".$fila['grado']."</td>
											<td style='color: green;'>".$fila['DSA']."</td>
											<td style='color: blue;'>".$fila['DA']."</td>
											<td style='color: orange;'>".$fila['DM']."</td>
											<td style='color: red;'>".$fila['DB']."</td>";

							        		//echo "<td><center><a href='lista-estudiantes_evalpres_sm1.php?idest=".$fila['id']."' class='btn btn-primary'><i class='fa fa-file-text'></i> Ver resultado</a></center></td></tr>";
							        	}
						        	?>
						        </tbody>
						    </table>
