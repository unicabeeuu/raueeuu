					...
					<div class="form-body">
						<form class="form-horizontal" action="../adminunicab/php/update-estudiante.php" method="POST">
							<div class="form-group">
								<label for="email_institucional" class="col-sm-2 control-label">Institutional Email</label>
								<div class="col-sm-8">
									...
									placeholder="Teacher Email" value="<?php echo $email_institucional;?>">
								</div>
							</div>
							...
							<div class="form-group">				
								...
								<div class="col-sm-8">
									<input type="text" class="form-control1" id="apellidos" name="apellidos" placeholder="Teacher Last Names" readonly="readonly" required maxlength="25" value="<?php echo $apellidos;?>">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									...
									placeholder="Teacher First Name" value="<?php echo $nombres;?>">
								</div>
							</div>

							<div class="form-group">
								<label for="n_documento" class="col-sm-2 control-label">Identification</label>
								<div class="col-sm-8">
									<input type="text" class="form-control1" id="n_documento" name="n_documento" required maxlength="15"
									placeholder="Teacher Document" readonly="readonly" value="<?php echo $n_documento;?>">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									...
									placeholder="Teacher Password" value="<?php echo $password;?>">
								</div>
							</div>
