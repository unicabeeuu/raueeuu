<?php
    ...
    //https://unicab.org/registro/docenteunicab/carnets/cb_mpdf8.php
	...
	<td class="barcodecell"><barcode code="978-0-9542246-0" text="1" class="barcode" />978-0-9542246-0</td>
	</tr>
	<tr>
	...
	$mpdf = new \Mpdf\Mpdf(["format" => "Letter", "margin_left" => 10, "margin_right" => 10, "margin_top" => 5, "margin_bottom" => 0, 
	"margin_header" => 10, "margin_footer" => 10, "showBarcodeNumbers" => TRUE]);
	
	$mpdf->WriteHTML($html);
	$mpdf->Output('cb_mpdf.pdf', 'F');*/
