          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="sidebar-menu">
              ...
              <li class="treeview">
                ...
                <ul class="treeview-menu">
                  <li><a href="https://unicab.org/registro/docenteunicab/asignacion.php"><i class="fa fa-battery-three-quarters "></i> Assignment</a></li>
                  <!--<li class='treeview'>
                      <a href='#'><i class='fa fa-file-pdf-o'></i>Certificados<i class='fa fa-angle-left pull-right'></i></a>
                      <ul class='treeview-menu'>
                          <li><a href='updreg/certificados_getdat.php'><i class='fa fa-angle-right'></i> By period</a></li>
              ...
              <li class="treeview">
                ...
                <ul class="treeview-menu">
                  <li><a href="updreg/adm.php"><i class="fa fa-cloud-upload"></i> Update Record</a></li>
                  <!--<li><a href="updreg/cod_entrevista.php"><i class="fa fa-power-off"></i> CÃ³digo entrevista</a></li>-->
                  <li><a href="updreg/adm1.php"><i class="fa fa-users"></i> Database</a></li>
                  ...
                  <li class='treeview'>
                      ...
                      <ul class='treeview-menu'>
                          <li><a href='updreg/preguntas_put_upddat.php'><i class='fa fa-minus'></i> Short Answer</a></li>
                          <li><a href='updreg/preguntas_putss_upddat.php'><i class='fa fa-check-circle-o'></i> Sel. sencilla</a></li>
                          <li><a href='updreg/preguntas_putsm2_upddat.php'><i class='fa fa-check-square-o'></i> Multiple Choice 2</a></li>
                          <li><a href='updreg/preguntas_putsm3_upddat.php'><i class='fa fa-check-square'></i> Multiple Choice 3</a></li>
                      </ul>
                  </li>
