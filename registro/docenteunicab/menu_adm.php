          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="sidebar-menu">
              ...
              <li class="treeview">
                ...
                <ul class="treeview-menu">
                  <li><a href="updreg/adm.php"><i class="fa fa-cloud-upload"></i> Update registry</a></li>
                  ...
                  <li><a href="updreg/act_moodle_upddat.php"><i class="fa fa-cogs"></i> Configure grades</a></li>
                  <li class='treeview'>
                  ...
                  <li><a href="menciones.php"><i class="fa fa-graduation-cap"></i> Honors</a></li>
                  ...
                  <li class='treeview'>
                      ...
                      <ul class='treeview-menu'>
                          ...
                          <li><a href='updreg/preguntas_putss_upddat.php'><i class='fa fa-check-circle-o'></i> Single choice</a></li>
