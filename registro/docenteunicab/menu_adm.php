            ...
            <ul class="sidebar-menu">
              ...
              <li class="treeview">
                ...
                <ul class="treeview-menu">
                  ...
                  <li><a href="../../admin-unicab/administrador/index.php"><i class="fa fa-angle-right"></i> AW - Psic</a></li>
              ...
              <li class="treeview">
                ...
                <ul class="treeview-menu">
                  <li><a href="https://unicab.org/registro/docenteunicab/asignacion.php"><i class="fa fa-battery-three-quarters "></i> Asignación</a></li>
                  <!--<li class='treeview'>
                      <a href='#'><i class='fa fa-file-pdf-o'></i>Certificados<i class='fa fa-angle-left pull-right'></i></a>
                      <ul class='treeview-menu'>
                          <li><a href='updreg/certificados_getdat.php'><i class='fa fa-angle-right'></i> Por periodo</a></li>
                          <li><a href='updreg/certificados_finales_getdat.php'><i class='fa fa-angle-right'></i> Finales</a></li>
                      </ul>
                  </li>-->
                  <li><a href="updreg/desemp_estud_per_getdat.php"><i class="fa fa-bar-chart"></i> Desempeño estudiantes</a></li>
              ...
              <li class="treeview">
                <a href="#">
                <i class="fa fa-cogs"></i>
                <span>Procesos Financieros</span>
                <i class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">
                  <!--<li><a href="../financieraunicab/ordenes_getdat.php"><i class="fa fa-usd"></i> Ordenes pago</a></li>-->
                  
                  <li><a href="../../admin-unicab/administrador/becas_descuentos.php" target="_blank"><i class="fa fa-usd"></i> Becas y descuentos</a></li>
              ...
              <li class="treeview">
                ...
                <ul class="treeview-menu">
                  <li><a href="updreg/adm.php"><i class="fa fa-cloud-upload"></i> Actualizar registro</a></li>
                  <!--<li><a href="updreg/cod_entrevista.php"><i class="fa fa-power-off"></i> CÃ³digo entrevista</a></li>-->
                  <li><a href="updreg/adm1.php"><i class="fa fa-users"></i> Base de datos</a></li>
                  <li><a href="updreg/act_moodle_upddat.php"><i class="fa fa-cogs"></i> Configurar calificaciones</a></li>
                  <li class='treeview'>
                  ...
                  <li class='treeview'>
                      ...
                      <ul class='treeview-menu'>
                          <li><a href='updreg/preguntas_put_upddat.php'><i class='fa fa-minus'></i> Respuesta corta</a></li>
                          <li><a href='updreg/preguntas_putss_upddat.php'><i class='fa fa-check-circle-o'></i> Sel. sencilla</a></li>
                          <li><a href='updreg/preguntas_putsm2_upddat.php'><i class='fa fa-check-square-o'></i> Sel. múltiple 2</a></li>
                          <li><a href='updreg/preguntas_putsm3_upddat.php'><i class='fa fa-check-square'></i> Sel. múltiple 3</a></li>
                      </ul>
                  </li>
