<?php
	...
	//https://unicab.org/registro/docenteunicab/updreg/domain_put_pal_upddat.php?pal=prueba
	...
	if($soporte_subido == "../../../assets/img/domain/") {
		$sql_update = "UPDATE tbl_metodo_domain SET palabra = '$pal' WHERE id = $idpal";
	}
	else {
		$sql_update = "UPDATE tbl_metodo_domain SET palabra = '$pal', imagen = '$soporte_subido' WHERE id = $idpal";
	}		
