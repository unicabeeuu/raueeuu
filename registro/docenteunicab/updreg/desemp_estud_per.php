<?php
	...
	set_time_limit(300);
	//https://unicab.org/registro/docenteunicab/updreg/desemp_estud_per.php?per=4&idgra=10&selgrupo=A
...
//if (isset($_SESSION['uniprofe']) || isset($_SESSION['unisuper'])) {
	...
	if($idgra == 110 || $idgra == 120 || $idgra == 170 || $idgra == 180) {
	    $keys = ['Nombre','BIO','SOC','QUA','FIS','ESP','ING','TEC'];
	}
	else {
	...
	while($row = $resultado->fetch_assoc()){
	    ...
	    if($control == 0) {
			...
			if($idgra == 110 || $idgra == 120 || $idgra == 170 || $idgra == 180) {
      		    //$cadena = $cadena."<tr><td>".$nombre."</td><td>".$bio."</td><td>".$soc."</td><td>".$num."</td><td>".$fis."</td><td>".$esp."</td><td>".$ing."</td><td>".$tec."</td></tr>";
      		    $cadena = $cadena."<tr><td>".$nombre."</td><td>".$bio."</td><td>".$soc."</td><td>".$num."</td><td>".$fis."</td><td>".$esp."</td><td>".$ing."</td><td>".$tec."</td>";
      		}
      		else {
      		    //$cadena = $cadena."<tr><td>".$nombre."</td><td>".$bio."</td><td>".$soc."</td><td>".$num."</td><td>".$esp."</td><td>".$ing."</td><td>".$tec."</td></tr>";
      		    $cadena = $cadena."<tr><td>".$nombre."</td><td>".$bio."</td><td>".$soc."</td><td>".$num."</td><td>".$esp."</td><td>".$ing."</td><td>".$tec."</td>";
      		}
      		//$cadena = $cadena."<tr><td>".$nombre."</td><td>".$bio."</td><td>".$soc."</td><td>".$num."</td><td>".$esp."</td><td>".$ing."</td><td>".$tec."</td></tr>";
	...
	$cadena = $cadena."</tbody></table><h3 style='color: #088A4B'>Total students: <span id='stot'>".$total."</span></h3>";
	echo $cadena;
