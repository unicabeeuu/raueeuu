...
<html>
	<head>
		...
		<!--<script>
			...
			function mr() {
				setTimeout("mostrar_resumen()",5000);
			}
	...
	<body>
		<center>
			...
			<?php
				if($control == 0) {
					...
					while($row = $resultado_r0->fetch_assoc()){
						...
						if($control == 1) {
						    //*****UPD TABLA CONTROL ****
    						$query_uc = "UPDATE tbl_control_upd SET resultado = 'OK' WHERE archivo = 'pen_gra_upddat2' AND paso = 'Borrado de tablas'";
						...
						if($control == 21) {
						    //*****UPD TABLA CONTROL ****
    						$query_uc = "UPDATE tbl_control_upd SET resultado = 'OK' WHERE archivo = 'pen_gra_upddat2' AND paso = 'Tabla notas_mood_temp cargada'";
    						$resultado_uc=$mysqli1->query($query_uc);
    						//*****UPD TABLA CONTROL ****
						...
						if($control == 22) {
						    //*****UPD TABLA CONTROL ****
    						$query_uc = "UPDATE tbl_control_upd SET resultado = 'OK' WHERE archivo = 'pen_gra_upddat2' AND paso = 'Tabla notas_temp cargada'";
    						$resultado_uc=$mysqli1->query($query_uc);
    						//*****UPD TABLA CONTROL ****
						...
						if($control == 23) {
						    //*****UPD TABLA CONTROL ****
    						$query_uc = "UPDATE tbl_control_upd SET resultado = 'OK' WHERE archivo = 'pen_gra_upddat2' AND paso = 'Tabla notas_temp_upd cargada'";
    						$resultado_uc=$mysqli1->query($query_uc);
    						//*****UPD TABLA CONTROL ****
							...
							while($row_tins = $resultado_tins->fetch_assoc()){
							    //*****UPD TABLA CONTROL ****
        						$query_uc = "UPDATE tbl_control_upd SET resultado = 'OK' WHERE archivo = 'pen_gra_upddat2' AND paso = 'Cargando tabla notas_temp_ins'";
        						$resultado_uc=$mysqli1->query($query_uc);
        						//*****UPD TABLA CONTROL ****
						...
						if($control == 4) {
						    //*****UPD TABLA CONTROL ****
    						$query_uc = "UPDATE tbl_control_upd SET resultado = 'OK' WHERE archivo = 'pen_gra_upddat2' AND paso = 'Tabla notas_temp_ins cargada'";
    						$resultado_uc=$mysqli1->query($query_uc);
    						//*****UPD TABLA CONTROL ****
							...
							if($resultado_en1 > 0) {
    							//*****UPD TABLA CONTROL ****
        						$query_uc = "UPDATE tbl_control_upd SET resultado = 'OK' WHERE archivo = 'pen_gra_upddat2' AND paso = 'Tabla notas_temp_no_ra cargada'";
        						$resultado_uc=$mysqli1->query($query_uc);
        						//*****UPD TABLA CONTROL ****
    						}
			...
			<?php
			    //*****UPD TABLA CONTROL ****
				$query_uc = "UPDATE tbl_control_upd SET resultado = 'OK' WHERE archivo = 'pen_gra_upddat2' AND paso = 'FIN'";
				$resultado_uc=$mysqli1->query($query_uc);
				//*****UPD TABLA CONTROL ****
