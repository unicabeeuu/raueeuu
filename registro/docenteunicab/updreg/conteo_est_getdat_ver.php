<?php 
	...
	//https://unicab.org/registro/docenteunicab/updreg/conteo_est_getdat_ver.php
	...
	//echo "<br>".$sql_est_m;
    echo "<br>total_estudiantes_m ".$total_usuarios_m;
	...
	//echo $sql_est_r;
	echo "<br>total_estudiantes_r ".$total_usuarios_r;
	...
	//echo $sql_solicitud;
	echo "<br>total_estudiantes_pre_a ".$total_usuarios_s;
	...
	echo "<br>total_estudiantes_pre_n ".$total_usuarios_s1;
	...
	echo "<br>total_estudiantes_s_a ".$total_usuarios_sn;
	...
	echo "<br>total_estudiantes_s_n ".$total_usuarios_sn1;
