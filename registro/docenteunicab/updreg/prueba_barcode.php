...
//Estas l¨ªneas son para generar qr
require '../../financieraunicab/phpqrcode/qrlib.php';
//$dir = '../../financieraunicab/phpqrcode/img/';
$dir = '../carnets/qr/';
//https://unicab.org/registro/docenteunicab/updreg/prueba_barcode.php
...
//echo $fecha2;
//echo "<br>".date("Y/m/d",strtotime($fecha2."+ 1 days")); 
//$fecha2pp = date("Ymd");
//echo "<br>".$fecha2pp;
//echo "<br>".date("Ymd",strtotime($fecha2pp."+ 30 days"));
...
//$filename = $dir.'qr2.png';
$filename = $dir.'qr_imelda.png';
$tamano = 10; //
$level = 'H'; //Tipo de precisi¨®n: Baja: L, Mediana: M, Alta: Q y M¨¢xima: H
$framesize = 2; //Marco en blanco alrededor de la imagen
$contenido = 'Gregory'; 
$contenido = 'https://unicab.org';
$contenido = 'tel:(057)3192997229';
$contenido = 'I=999999|V=188500|C=2020_pm9|FechaPago=20201210';
$contenido = 'Acud=Imelda Vergara|Cel=(57) 3158895275|Email=rectoria@unicab.org|Dir=Calle 12 10-75 Ap 601';
...
/*include 'mpdf8/vendor/autoload.php';
