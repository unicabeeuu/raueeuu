<?php
	//Muestra los registros a ser actualizado e insertados para un pensamiento y un grado
	...
	//Consulta general
	$query0 = "SELECT * FROM querys_ra WHERE pensamiento = '$pen' AND grados = '$gra'";
	//echo $query0;
?>
	...
	<body>
		<center>
			...
			<?php
				...
				header("Location: pen_gra_upddat3.php?p=1&pi=1&id=".$id);
			?>
			<br/>
		</center>
	</body>
