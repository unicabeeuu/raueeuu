...
if (isset($_SESSION['uniprofe'])) {
    ...
    $query = "SELECT DISTINCT u.id, cc.name, u.lastname, u.firstname, u.city, u.email, u.username, 
        ...
        AND ct.contextlevel = 50 AND ra.roleid = 5 AND u.deleted = 0 AND cc.name NOT IN ('Psicología y Coordinación','Capacitación','Inducciones')
