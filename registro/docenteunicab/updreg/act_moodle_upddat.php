        ...
        <script>
            ...
            function validapor() {
                ...
                if(esCoincidente) {
                    ...
                    input_por.setCustomValidity("Ingrese sólo números para el porcentaje y máximo tres dígitos");
            ...
            function control_conf() {
                $.ajax({
            		type:"POST",
            		url:"control_conf_cal_f.php",
            		data:"per=" + $("#txtper").val(),
            		success:function(r) {
            		    //alert (r);
            		    $("#divtabla").empty();
                            						...
                            						<li><h3>LISTADO DE ACTIVIDADES POR<span style="color: white;">.....</span>
                            							...
                            							<ul class="msecund">
                            								<li>
																...
																<?php
																    if($id == 18) {
																        echo '<label style="color: white;">...</label>';
																        echo '<button class="btn btn-secundary" onclick="control_conf()">Control</button>';
																        echo '<input type="text" id="txtper" placeholder="per" width="50px"/>';
																    }
																?>
