...
//if (isset($_SESSION['uniprofe']) || isset($_SESSION['unisuper'])) {
	...
	//Se agrega el idgra_m de 32 en el caso de noveno, d¨¦cimo y once... que es el id del curso ¨¦nfasis en educaci¨®n f¨ªsica en moodle
    ...
    if($idgra_m == 15 || $idgra_m == 16 || $idgra_m == 17) {
	    ...
	    case CONCAT(cc.id,gi.idnumber) when '19TP1I' then 61999 when '19TP2I' then 61999 when '19TP3I' then 61999 when '19TP4I' then 61999 
            	...
            	when '22TP1F' then 71999 when '22TP2F' then 71999 when '23TP1F' then 75999 when '23TP2F' then 75999 
            	when '16TP1F' then '51999' when '16TP2F' then '51999' when '16TP3F' then '51999' when '16TP4F' then '51999' 
            	when '17TP1F' then '55999' when '17TP2F' then '55999' when '17TP3F' then '55999' when '17TP4F' then '55999' 
	...
	//************** ESTE EL PARAMETRO QUE HAY QUE CAMBIAR EL LA BASE DE DATOS PARA CONFIGURAR LA ACTUALIZACION DE CALIFICACIONES AL HACER DOBLE CLIC
	//Se valida el par¨¢metro
	$param = 0;
	...
	if (isset($_SESSION['uniprofe'])) {
	    if($idgra_m == 15 || $idgra_m == 16 || $idgra_m == 17) {
            ...
            (SELECT nte.id_est, nte.lastname, nte.firstname, nte.shortname, 
            	...
            	when 'Ciclo VTP1F' then 71999 when 'Ciclo VTP2F' then 71999 when 'Ciclo VITP1F' then 75999 when 'Ciclo VITP2F' then 75999 
            	when 'D¨¦cimo 10¡ãTP1F' then '51999' when 'D¨¦cimo 10¡ãTP2F' then '51999' when 'D¨¦cimo 10¡ãTP3F' then '51999' when 'D¨¦cimo 10¡ãTP4F' then '51999' 
            	when 'Once 11¡ãTP1F' then '55999' when 'Once 11¡ãTP2F' then '55999' when 'Once 11¡ãTP3F' then '55999' when 'Once 11¡ãTP4F' then '55999'
