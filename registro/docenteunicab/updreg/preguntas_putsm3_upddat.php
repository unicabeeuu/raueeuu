...
<html lang="es">
        ...
        <script>
            ...
            function continuar() {
                ...
                if (seltp == "NA") {
                    ...
                    $("#txt_tp1").val("SELECCION MULTIPLE 3");
            ...
            function mostrar_submit(id) {
                ...
                if(tema == 2) {
                    ...
                    let f = parseInt($("#ctr_txtresp3").val());
                    ...
                    + parseInt($("#ctr_txtotro").val()) + parseInt($("#ctr_txtrespin1").val()) + parseInt($("#ctr_txtresp3").val()) + parseInt($("#ctr_txtresp2").val());
                    ...
                    (f == 1) ? $("#txtresp3").addClass("error") : $("#txtresp3").removeClass("error");
                    ...
                    control = parseInt($("#ctr_txtpreg").val()) + parseInt($("#ctr_txtresp").val()) + parseInt($("#ctr_txtretro").val()) + 
                    + parseInt($("#ctr_seltema").val()) + parseInt($("#ctr_txtrespin1").val()) + parseInt($("#ctr_txtresp3").val()) + parseInt($("#ctr_txtresp2").val());
            ...
            function mostrar_editar(id) {
                ...
                if(id == "txtupdotro") {
                    ...
                    $("#lblupdresp3").html(long);
                    if(long > 600) {
                        $("#ctr_txtupdresp3").val(1);
                    }
                }
                else if(id == "txtupdresp2") {
                ...
                if(tema == 2) {
                    ...
                    let f = parseInt($("#ctr_txtupdresp3").val());
                    ...
                    + parseInt($("#ctr_txtupdotro").val()) + parseInt($("#ctr_txtupdrespin1").val()) + parseInt($("#ctr_txtupdresp3").val()) + parseInt($("#ctr_txtupdresp2").val());
                    ...
                    (f == 1) ? $("#txtupdresp3").addClass("error") : $("#txtupdresp3").removeClass("error");
                    ...
                    control = parseInt($("#ctr_txtupdpreg").val()) + parseInt($("#ctr_txtupdresp").val()) + parseInt($("#ctr_txtupdretro").val()) + 
                    + parseInt($("#ctr_selupdtema").val()) + parseInt($("#ctr_txtupdrespin1").val()) + parseInt($("#ctr_txtupdresp3").val()) + parseInt($("#ctr_txtupdresp2").val());
                ...
                if(tema == 2) {
                    ...
                    $.ajax({
                        ...
                        success:function(r) {
                            //alert(r);
                            $("#idn_tema").val(r);
                            guardar_preg(idgra, idpen, idtp, pregunta, r1ok, r, retro, r1no, r3ok, r2ok);
                        }
                    });
                }
                else if(tema == 1) {
                    ...
                    guardar_preg(idgra, idpen, idtp, pregunta, r1ok, idtema, retro, r1no, r3ok, r2ok);
                }
            }
            
            function guardar_preg(idgra, idpen, idtp, pregunta, r1ok, idtema, retro, r1no, r3ok, r2ok) {
                $("#idpreg").html("");
            ...
            function enviardat(id, idtema, pregunta, r1ok, retro, imagen, r1no, r3ok, r2ok) {
                //alert (idtema);
                $("#idpregunta").val(id);
                ...
                //$("#txt_tp1").val(seltp_txt);
                $("#txtupd_tp1").val("SELECCION MULTIPLE 3");
                ...
                $("#txtupdresp3").val(r3ok);
                long = $("#txtupdresp3").val().length;
                $("#lblupdresp3").html(long);
                ...
                if(tema == 2) {
                    ...
                    $.ajax({
                        ...
                        success:function(r) {
                            //alert(r);
                            $("#idn_tema").val(r);
                            modificar_preg(idgra, idpen, idtp, pregunta, r1ok, r, retro, idpregunta, r1no, r3ok, r2ok);
                        }
                    });
                }
                else if(tema == 1) {
                    ...
                    modificar_preg(idgra, idpen, idtp, pregunta, r1ok, idtema, retro, idpregunta, r1no, r3ok, r2ok);
                }
            }
            
            function modificar_preg(idgra, idpen, idtp, pregunta, r1ok, idtema, retro, idpreg, r1no, r3ok, r2ok) {
                //alert(idtp);
                if(idtp == 5) {
	...
	<body id="bodyadm" class="cbp-spmenu-push">
    	...
    	<!-- Modal de nueva pregunta selección múltiple 3 -->
        ...
        <!-- Modal edición pregunta selección múltiple 3 -->
