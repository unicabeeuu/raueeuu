<?php
	...
	$sql="INSERT INTO tbl_transac_bal (tipo_doc, documento, fexpedicion, nombres, apellidos, email, pais, 
	...
	<body>
		<center>
			<?php
				if($resultado > 0){
			?>
			<h1>Nueva Transacción Guardada</h1>
			<?php
				}
				else{
			?>
			<h1 style="color:red">Error Guardando Transacción</h1>
