	...
	<body id="bodyadm" class="cbp-spmenu-push">
               		...
               		<div class="charts">		
               		 	<div class="mid-content-top charts-grids">	
                                    ...
                                    <div id="cont">
                            			...
                            			<div id="div2">
                            				<fieldset id="fl1">
                            				    <legend><h3>QUESTION BANK <i class="fa fa-arrow-right "></i> MULTIPLE CHOICE QUESTION 2</h3>
          ...
          <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">NEW MULTIPLE CHOICE QUESTION 2</h5>
        ...
        <div class="modal fade" id="modal_editar_preg" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">EDIT MULTIPLE CHOICE QUESTION 2</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
