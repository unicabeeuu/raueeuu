...
<html lang="es">
        ...
        <script>
            ...
            function continuar() {
                ...
                if (seltp == "NA") {
                    ...
                    $("#txt_tp1").val("SELECCION MULTIPLE 2");
            ...
            function mostrar_submit(id) {
                ...
                if(tema == 2) {
                    ...
                    let g = parseInt($("#ctr_txtresp2").val());
                    //alert("a=" + a + " b=" + b + " c=" + c + " d=" + d + " e=" + e + " f=" + f + " g=" + g);
                    
                    control = parseInt($("#ctr_txtpreg").val()) + parseInt($("#ctr_txtresp").val()) + parseInt($("#ctr_txtretro").val()) + 
                    + parseInt($("#ctr_txtotro").val()) + parseInt($("#ctr_txtrespin1").val()) + parseInt($("#ctr_txtrespin2").val()) + parseInt($("#ctr_txtresp2").val());
                    ...
                    (g == 1) ? $("#txtresp2").addClass("error") : $("#txtresp2").removeClass("error");
                }
                else {
                    let a = parseInt($("#ctr_txtpreg").val());
                    let b = parseInt($("#ctr_txtresp").val());
                    ...
                    control = parseInt($("#ctr_txtpreg").val()) + parseInt($("#ctr_txtresp").val()) + parseInt($("#ctr_txtretro").val()) + 
                    + parseInt($("#ctr_seltema").val()) + parseInt($("#ctr_txtrespin1").val()) + parseInt($("#ctr_txtrespin2").val()) + parseInt($("#ctr_txtresp2").val());
            ...
            function mostrar_editar(id) {
                ...
                if(id == "txtupdotro") {
                    ...
                    $("#lblupdresp2").html(long);
                    if(long > 600) {
                        $("#ctr_txtupdresp2").val(1);
                    }
                }
                else if(id == "txtupdretro") {
                ...
                if(tema == 2) {
                    ...
                    let g = parseInt($("#ctr_txtupdresp2").val());
                    //alert("a=" + a + " b=" + b + " c=" + c + " d=" + d + " e=" + e + " f=" + f + " g=" + g);
                    
                    control = parseInt($("#ctr_txtupdpreg").val()) + parseInt($("#ctr_txtupdresp").val()) + parseInt($("#ctr_txtupdretro").val()) + 
                    + parseInt($("#ctr_txtupdotro").val()) + parseInt($("#ctr_txtupdrespin1").val()) + parseInt($("#ctr_txtupdrespin2").val()) + parseInt($("#ctr_txtupdresp2").val());
                    ...
                    (g == 1) ? $("#txtupdresp2").addClass("error") : $("#txtupdresp2").removeClass("error");
                }
                else {
                    ...
                    control = parseInt($("#ctr_txtupdpreg").val()) + parseInt($("#ctr_txtupdresp").val()) + parseInt($("#ctr_txtupdretro").val()) + 
                    + parseInt($("#ctr_selupdtema").val()) + parseInt($("#ctr_txtupdrespin1").val()) + parseInt($("#ctr_txtupdrespin2").val()) + parseInt($("#ctr_txtupdresp2").val());
                ...
                if(tema == 2) {
                    ...
                    $.ajax({
                        ...
                        success:function(r) {
                            //alert(r);
                            $("#idn_tema").val(r);
                            guardar_preg(idgra, idpen, idtp, pregunta, r1ok, r, retro, r1no, r2no, r2ok);
                        }
                    });
                }
                else if(tema == 1) {
                    ...
                    guardar_preg(idgra, idpen, idtp, pregunta, r1ok, idtema, retro, r1no, r2no, r2ok);
                }
            }
            
            function guardar_preg(idgra, idpen, idtp, pregunta, r1ok, idtema, retro, r1no, r2no, r2ok) {
                $("#idpreg").html("");
                ...
                if(idtp == 4) {
                    ...
                    formData.append('r2ok',r2ok);
                    formData.append('retro',retro);
                    formData.append('file',files);
                    $.ajax({
                        type:"POST",
                        url:"pregunta_sm2_putdat.php",
                        data: formData,
                        processData: false,
                        contentType: false,
                        success:function(r) {
            ...
            function enviardat(id, idtema, pregunta, r1ok, retro, imagen, r1no, r2no, r2ok) {
                //alert (idtema);
                $("#idpregunta").val(id);
                ...
                //$("#txt_tp1").val(seltp_txt);
                $("#txtupd_tp1").val("SELECCION MULTIPLE 2");
                ...
                $("#txtupdresp2").val(r2ok);
                long = $("#txtupdresp2").val().length;
                $("#lblupdresp2").html(long);
                ...
                if(tema == 2) {
                    ...
                    $.ajax({
                        ...
                        success:function(r) {
                            //alert(r);
                            $("#idn_tema").val(r);
                            modificar_preg(idgra, idpen, idtp, pregunta, r1ok, r, retro, idpregunta, r1no, r2no, r2ok);
                        }
                    });
                }
                else if(tema == 1) {
                    ...
                    modificar_preg(idgra, idpen, idtp, pregunta, r1ok, idtema, retro, idpregunta, r1no, r2no, r2ok);
                }
            }
            
            function modificar_preg(idgra, idpen, idtp, pregunta, r1ok, idtema, retro, idpreg, r1no, r2no, r2ok) {
                //alert(idtp);
                if(idtp == 4) {
	...
	<body id="bodyadm" class="cbp-spmenu-push">
               		...
               		<div class="charts">		
               		 	<div class="mid-content-top charts-grids">	
                                    ...
                                    <div id="cont">
                            			...
                            			<div id="div2">
                            				<fieldset id="fl1">
                            				    <legend><h3>BANCO DE PREGUNTAS <i class="fa fa-arrow-right "></i> PREGUNTA DE SELECCION MULTIPLE 2</h3>
                            				        <img id="imgt" src="../../images/preguntas/sm2_2.png" width="147"/>
                            				    </legend>
    	...
    	<!-- Modal de nueva pregunta selección múltiple 2 -->
          ...
          <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">NUEVA PREGUNTA DE SELECCION MULTIPLE 2</h5>
        ...
        <!-- Modal edición pregunta selección múltiple 2 -->
        <div class="modal fade" id="modal_editar_preg" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">EDITAR PREGUNTA DE SELECCION MULTIPLE 2</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
