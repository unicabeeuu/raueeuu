<?php
	...
	//https://unicab.org/registro/docenteunicab/updreg/certificados_finales_getdat1.php?idgra=11&a=2025
	$codigo = "";
	...
	while($row = $resultado->fetch_assoc()) {
        ...
        $cadena = $cadena."<tr>
                ...
                <td>".$row['id_grado']."</td>
                <td>".$row['identificacion']."</td>
                <td><a href='".$row['ruta1']."?t=".$codigo."' target='_blank'>".$row['nombre']."</a></td>
                </tr>";
