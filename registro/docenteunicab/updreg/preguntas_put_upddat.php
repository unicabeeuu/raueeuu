                ...
                if(tema == 2) {
                    ...
                    $.ajax({
                        ...
                        success:function(r) {
                            //alert(r);
                            $("#idn_tema").val(r);
                            guardar_preg(idgra, idpen, idtp, pregunta, r1ok, r, retro);
                        }
                    });
                }
                else if(tema == 1) {
                    ...
                    guardar_preg(idgra, idpen, idtp, pregunta, r1ok, idtema, retro);
                }
            }
                ...
                if(tema == 2) {
                    ...
                    $.ajax({
                        ...
                        success:function(r) {
                            //alert(r);
                            $("#idn_tema").val(r);
                            modificar_preg(idgra, idpen, idtp, pregunta, r1ok, r, retro, idpregunta);
                        }
                    });
                }
                else if(tema == 1) {
                    ...
                    modificar_preg(idgra, idpen, idtp, pregunta, r1ok, idtema, retro, idpregunta);
                }
            }
               		...
               		<div class="charts">		
               		 	<div class="mid-content-top charts-grids">	
                                    ...
                                    <div id="cont">
                            			...
                            			<div id="div2">
                            				<fieldset id="fl1">
                            				    <legend><h3>BANCO DE PREGUNTAS <i class="fa fa-arrow-right "></i> PREGUNTA DE RESPUESTA CORTA</h3>
