<?php
	...
	$r3ok = str_replace("_", " ", $_REQUEST['r3ok']);
	...
	if ($idtp == 5) {
	    if($soporte_subido == "../../images/preguntas/") {
        	...
        	VALUES ($idgra, $idpen, $idtp, $idtema, '$preg', '$r1ok', '$r2ok', '$r3ok', '$r1no', 'NA', 'NA', 'NA', '$retro', 'NA')";
	    }
	    else {
	        $sql_insert = "INSERT INTO tbl_preguntas (id_grado, id_materia, id_tipo_pregunta, id_tema, pregunta, r1ok, r2ok, r3ok, r1no, r2no, r3no, r4no, retroalimentacion, imagen) 
        	VALUES ($idgra, $idpen, $idtp, $idtema, '$preg', '$r1ok', '$r2ok', '$r3ok', '$r1no', 'NA', 'NA', 'NA', '$retro', '$soporte_subido')";
	    }
	}
	//echo "<br>".$sql_insert;
