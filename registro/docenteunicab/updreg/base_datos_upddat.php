<?php  
	...
	$sql_drop = "DELETE FROM equivalence_idest_temp";
	...
	$sql = "INSERT INTO equivalence_idest_temp (id, grado, apellidos, nombres, ciudad, email_inst, usuario, a_modif) 
	SELECT id, grado, apellidos, nombres, ciudad, email_inst, usuario, a_modif 
	FROM `tbl_estudiantes_mood` WHERE id NOT IN (SELECT id_moodle FROM equivalence_idest) AND grado != 'Diplomados';";
	$resultado_sql = $mysqli1->query($sql);
	echo $sql."<br>";
	echo "tabla equivalence_idest_temp cargada<br>";
	$control = 0;
