...
//if (isset($_SESSION['uniprofe']) || isset($_SESSION['unisuper'])) {
	...
	if($idgra == 110 || $idgra == 120 || $idgra == 170 || $idgra == 180) {
	    ...
	    $cadena = "<table class='table' border='1px'><thead><tr><td>Name</td><td>BIO</td><td>SOC</td><td>QUA</td><td>SPA</td><td>ENG</td><td>TEC</td><td></td></tr></thead><tbody>";
	}
	...
	$cadena = $cadena."</tbody></table><h3 style='color: #B40404'>Total students: <span id='stot6'>".$total."</span></h3>";
	echo $cadena;
