<?php
	...
	//https://unicab.org/registro/docenteunicab/updreg/domain_put_putdat_i.php?pal=prueba
	...
	$sql_insert = "INSERT INTO tbl_metodo_domain_i (palabra, imagen, fecha, estado) 
        	VALUES ('$pal', '$soporte_subido', '$fecha2', 0)";
	//echo "<br>".$sql_insert;
	$res_insert=mysqli_query($conexion,$sql_insert);
	
	//Se consulta el id de la palabra
	$sql_idpreg = "SELECT id FROM tbl_metodo_domain_i WHERE palabra = '$pal'";
