<?php
	...
	//https://unicab.org/registro/docenteunicab/updreg/pregunta_putdat.php?idgra=7&idpen=5&idtp=4&idtema=27&preg=UNA_CRAYOLA.&r1ok=31/4&retro=DEBES_REFORZAR_OPERACIONES_CON_FRACCIONES.
	...
	if ($idtp == 2) {
	    if($soporte_subido == "../../images/preguntas/") {
        	...
        	VALUES ($idgra, $idpen, $idtp, $idtema, '$preg', '$r1ok', 'NA', 'NA', 'NA', 'NA', 'NA', 'NA', '$retro', 'NA')";
	    }
	    else {
	        $sql_insert = "INSERT INTO tbl_preguntas (id_grado, id_materia, id_tipo_pregunta, id_tema, pregunta, r1ok, r2ok, r3ok, r1no, r2no, r3no, r4no, retroalimentacion, imagen) 
        	VALUES ($idgra, $idpen, $idtp, $idtema, '$preg', '$r1ok', 'NA', 'NA', 'NA', 'NA', 'NA', 'NA', '$retro', '$soporte_subido')";
	    }
	}
	//echo "<br>".$sql_insert;
