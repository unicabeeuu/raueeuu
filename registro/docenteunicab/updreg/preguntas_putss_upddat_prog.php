        ...
        <script>
                ...
                if(tema == 2) {
                    ...
                    $.ajax({
                        ...
                        success:function(r) {
                            //alert(r);
                            $("#idn_tema").val(r);
                            guardar_preg(idgra, 0, idtp, pregunta, r1ok, r, retro, r1no, r2no, r3no);
                        }
                    });
                }
                else if(tema == 1) {
                    ...
                    guardar_preg(idgra, 0, idtp, pregunta, r1ok, idtema, retro, r1no, r2no, r3no);
                }
            }
            ...
            function guardar_preg(idgra, idpen, idtp, pregunta, r1ok, idtema, retro, r1no, r2no, r3no) {
                ...
                if(idtp == 3) {
                    ...
                    $.ajax({
                        type:"POST",
                        url:"pregunta_ss_putdat_html5.php",
                        data: formData,
                        processData: false,
                        contentType: false,
                        success:function(r) {
                ...
                if(tema == 2) {
                    ...
                    $.ajax({
                        ...
                        success:function(r) {
                            //alert(r);
                            $("#idn_tema").val(r);
                            modificar_preg(idgra, 0, idtp, pregunta, r1ok, r, retro, idpregunta, r1no, r2no, r3no);
                        }
                    });
                }
                else if(tema == 1) {
                    ...
                    modificar_preg(idgra, 0, idtp, pregunta, r1ok, idtema, retro, idpregunta, r1no, r2no, r3no);
                }
            }
            ...
            function modificar_preg(idgra, idpen, idtp, pregunta, r1ok, idtema, retro, idpreg, r1no, r2no, r3no) {
                ...
                if(idtp == 3) {
                    ...
                    $.ajax({
                        type:"POST",
                        url:"pregunta_ss_upddat_html5.php",
                        data: formData,
                        processData: false,
                        contentType: false,
                        success:function(r) {
               		...
               		<div class="charts">		
               		 	<div class="mid-content-top charts-grids">	
                                    ...
                                    <div id="cont">
                            			...
                            			<div id="div2">
                            				<fieldset id="fl1">
                            				    <legend><h3>BANCO DE PREGUNTAS EVALUACIÓN CARGOS <i class="fa fa-arrow-right "></i> PREGUNTA DE SELECCION SENCILLA</h3>
