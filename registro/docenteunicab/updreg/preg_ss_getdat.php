<?php
	...
	set_time_limit(300);
	//https://unicab.org/registro/docenteunicab/updreg/preg_ss_getdat.php?idgra=10&idpen=5
	...
	WHERE p.id_tema = tp.id AND p.id_grado = $idgra AND p.id_materia = $idpen AND p.id_tipo_pregunta = 3";
	//echo $query1;
