        ...
        <script>
            ...
            $(function() {
            	...
            	$("#selpenp").change(function() {
            		...
            		if (pen == "NA") {
                		...
                		if(gra == "NA") {
                		    ...
                		    //Se muestran la cantidad de preguntas por tema
                    		//alert("cantidad de preguntas");
                    		cantidad_preguntas(gra, pen);
            	...
            	$("#selop").change(function() {
            	    $("#divtabla").empty();
            	    let idgra = $("#selgrap").val();
            	    let idpen = $("#selpenp").val();
            	    let op = $("#selop").val();
            	    //alert(op);
            	...
            	$("#seltema").change(function() {
            	    ...
            	    let tema = $("#seltema").val();
            	    let tematxt = $("select[name='seltema'] option:selected").text();
            	    
            		if(tema == 1) {
            			$("#btnguardar").hide();
            			$("#ctr_seltema").val(1);
            			let texto = "Debe seleccionar un tema";
            	...
            	$("#selupdtema").change(function() {
            	    ...
            	    let tema = $("#selupdtema").val();
            	    let tematxt = $("select[name='selupdtema'] option:selected").text();
            	...
            	$("#adjunto").change(function () {
     			    ...
     			    let path = "../../images/preguntas/";
     			    let archivo = path + img;
     			    //alert(pesoimg);
     			    if(pesoimg > 200) {
     			        $("#ctr_adjunto").val(1);
     			        let texto = "El peso permitido para la imagen es de 200 Kb ";
                        $("#lblmsg").html(texto).css("color","red");
                        $("#adjunto").val(null);
     			    }
     			    else {
            ...
            function mayus(e, id, desc) {
                ...
                else if(id == "txtupdrespin1") {
                    validar_textoupd(id, desc);
                }
                else if(id == "txtupdrespin2") {
                    validar_textoupd(id, desc);
                }
                else if(id == "txtupdrespin3") {
                    validar_textoupd(id, desc);
                }
                else {
                    validar_texto(id, desc);
            ...
            function continuar() {
                ...
                $("#ctr_txtpreg").val(1);
                $("#ctr_txtresp").val(1);
                $("#ctr_txtrespin1").val(1);
                $("#ctr_txtrespin2").val(1);
                $("#ctr_txtrespin3").val(1);
                $("#ctr_txtretro").val(1);
                $("#ctr_txtotro").val(1);
                $("#ctr_seltema").val(1);
                $("#divotro").hide();
                ...
                if (seltp == "NA") {
                    ...
                    $("#txt_tp1").val("SELECCION SENCILLA");
            ...
            function mostrar_submit(id) {
                ...
                else if(id == "txtrespin1") {
                    $("#lblrespin1").html(long);
                    if(long > 600) {
                        $("#ctr_txtrespin1").val(1);
                    }
                }
                else if(id == "txtrespin2") {
                    $("#lblrespin2").html(long);
                    if(long > 600) {
                        $("#ctr_txtrespin2").val(1);
                    }
                }
                else if(id == "txtrespin3") {
                    $("#lblrespin3").html(long);
                    if(long > 600) {
                        $("#ctr_txtrespin3").val(1);
                    }
                }
                ...
                if(tema == 2) {
                    let a = parseInt($("#ctr_txtpreg").val());
                    let b = parseInt($("#ctr_txtresp").val());
                    let c = parseInt($("#ctr_txtretro").val());
                    let d = parseInt($("#ctr_txtotro").val());
                    
                    let e = parseInt($("#ctr_txtrespin1").val());
                    let f = parseInt($("#ctr_txtrespin2").val());
                    let g = parseInt($("#ctr_txtrespin3").val());
                    //alert("a=" + a + " b=" + b + " c=" + c + " d=" + d + " e=" + e + " f=" + f + " g=" + g);
                    
                    control = parseInt($("#ctr_txtpreg").val()) + parseInt($("#ctr_txtresp").val()) + parseInt($("#ctr_txtretro").val()) + 
                    + parseInt($("#ctr_txtotro").val()) + parseInt($("#ctr_txtrespin1").val()) + parseInt($("#ctr_txtrespin2").val()) + parseInt($("#ctr_txtrespin3").val());
                    ...
                    (e == 1) ? $("#txtrespin1").addClass("error") : $("#txtrespin1").removeClass("error");
                    (f == 1) ? $("#txtrespin2").addClass("error") : $("#txtrespin2").removeClass("error");
                    (g == 1) ? $("#txtrespin3").addClass("error") : $("#txtrespin3").removeClass("error");
                }
                else {
                    let a = parseInt($("#ctr_txtpreg").val());
                    let b = parseInt($("#ctr_txtresp").val());
                    let c = parseInt($("#ctr_txtretro").val());
                    let d = parseInt($("#ctr_seltema").val());
                    ...
                    control = parseInt($("#ctr_txtpreg").val()) + parseInt($("#ctr_txtresp").val()) + parseInt($("#ctr_txtretro").val()) + 
                    + parseInt($("#ctr_seltema").val()) + parseInt($("#ctr_txtrespin1").val()) + parseInt($("#ctr_txtrespin2").val()) + parseInt($("#ctr_txtrespin3").val());
            ...
            function mostrar_editar(id) {
                ...
                if(id == "txtupdotro") {
                    ...
                    $("#lblupdrespin1").html(long);
                    if(long > 600) {
                        $("#ctr_txtupdrespin1").val(1);
                    }
                }
                else if(id == "txtupdrespin2") {
                    $("#lblupdrespin2").html(long);
                    if(long > 600) {
                        $("#ctr_txtupdrespin2").val(1);
                    }
                }
                else if(id == "txtupdrespin3") {
                    $("#lblupdrespin3").html(long);
                    if(long > 600) {
                        $("#ctr_txtupdrespin3").val(1);
                    }
                }
                else if(id == "txtupdretro") {
                ...
                if(tema == 2) {
                    let a = parseInt($("#ctr_txtupcpreg").val());
                    let b = parseInt($("#ctr_txtupdresp").val());
                    let c = parseInt($("#ctr_txtupdretro").val());
                    let d = parseInt($("#ctr_txtupdotro").val());
                    
                    let e = parseInt($("#ctr_txtupdrespin1").val());
                    let f = parseInt($("#ctr_txtupdrespin2").val());
                    let g = parseInt($("#ctr_txtupdrespin3").val());
                    //alert("a=" + a + " b=" + b + " c=" + c + " d=" + d + " e=" + e + " f=" + f + " g=" + g);
                    
                    control = parseInt($("#ctr_txtupdpreg").val()) + parseInt($("#ctr_txtupdresp").val()) + parseInt($("#ctr_txtupdretro").val()) + 
                    + parseInt($("#ctr_txtupdotro").val()) + parseInt($("#ctr_txtupdrespin1").val()) + parseInt($("#ctr_txtupdrespin2").val()) + parseInt($("#ctr_txtupdrespin3").val());
                    ...
                    (e == 1) ? $("#txtupdrespin1").addClass("error") : $("#txtupdrespin1").removeClass("error");
                    (f == 1) ? $("#txtupdrespin2").addClass("error") : $("#txtupdrespin2").removeClass("error");
                    (g == 1) ? $("#txtupdrespin3").addClass("error") : $("#txtupdrespin3").removeClass("error");
                }
                else {
                    let a = parseInt($("#ctr_txtupdpreg").val());
                    let b = parseInt($("#ctr_txtupdresp").val());
                    let c = parseInt($("#ctr_txtupdretro").val());
                    let d = parseInt($("#ctr_selupdtema").val());
                    ...
                    control = parseInt($("#ctr_txtupdpreg").val()) + parseInt($("#ctr_txtupdresp").val()) + parseInt($("#ctr_txtupdretro").val()) + 
                    + parseInt($("#ctr_selupdtema").val()) + parseInt($("#ctr_txtupdrespin1").val()) + parseInt($("#ctr_txtupdrespin2").val()) + parseInt($("#ctr_txtupdrespin3").val());
            ...
            function consultar_preguntas(idgra, idpen) {
                $.ajax({
                    type:"POST",
                    url:"preg_ss_getdat.php",
                    data:"idgra=" + idgra + "&idpen=" + idpen,
                    success:function(r) {
                        //alert(r);
                        $("#divtabla").html(r);
            ...
            function guardar() {
                ...
                let idpen = $("#txtidpen").val();
                let idtp = $("#txtidtp1").val();
                let pregunta = $("#txtpreg").val();
                pregunta = pregunta.replace(" ", "_");
                pregunta = pregunta.replace("+", "|");
                let r1ok = $("#txtresp").val();
                r1ok = r1ok.replace(" ", "_");
                let idtema = $("#seltema").val();
                let retro = $("#txtretro").val();
                retro = retro.replace(" ", "_");
                
                let r1no = $("#txtrespin1").val();
                r1no = r1no.replace(" ", "_");
                let r2no = $("#txtrespin2").val();
                r2no = r2no.replace(" ", "_");
                let r3no = $("#txtrespin3").val();
                r3no = r3no.replace(" ", "_");
                
                let tema = $("#seltema").val();
                let ntema = $("#txtotro").val();
                ...
                if(tema == 2) {
                    ...
                    $.ajax({
                        ...
                        data:"ntema=" + ntema + "&idgra=" + idgra + "&idpen=" + idpen,
                        success:function(r) {
                            //alert(r);
                            $("#idn_tema").val(r);
                            guardar_preg(idgra, idpen, idtp, pregunta, r1ok, r, retro, r1no, r2no, r3no);
                        }
                    });
                }
                else if(tema == 1) {
                    ...
                    guardar_preg(idgra, idpen, idtp, pregunta, r1ok, idtema, retro, r1no, r2no, r3no);
                }
            }
            
            function guardar_preg(idgra, idpen, idtp, pregunta, r1ok, idtema, retro, r1no, r2no, r3no) {
                $("#idpreg").html("");
                ...
                if(idtp == 3) {
                    ...
                    formData.append('r1no',r1no);
                    formData.append('r2no',r2no);
                    formData.append('r3no',r3no);
                    formData.append('retro',retro);
                    formData.append('file',files);
                    $.ajax({
                        type:"POST",
                        url:"pregunta_ss_putdat.php",
                        data: formData,
                        processData: false,
                        contentType: false,
                        success:function(r) {
                ...
                cantidad_preguntas1(idgra, idpen);
                
                setTimeout(function() {
                    cantidad_preguntas2(idgra, idpen);
                },2000);
            }
            
            function enviardat(id, idtema, pregunta, r1ok, retro, imagen, r1no, r2no, r3no) {
                //alert (idtema);
                $("#idpregunta").val(id);
                ...
                //$("#txt_tp1").val(seltp_txt);
                $("#txtupd_tp1").val("SELECCION SENCILLA");
                
                $("#txtupdpreg").val(pregunta);
                let long = $("#txtupdpreg").val().length;
                //alert(long);
                $("#lblupdpreg").html(long);
                ...
                $("#txtupdrespin1").val(r1no);
                long = $("#txtupdrespin1").val().length;
                $("#lblupdrespin1").html(long);
                
                $("#txtupdrespin2").val(r2no);
                long = $("#txtupdrespin2").val().length;
                $("#lblupdrespin2").html(long);
                
                $("#txtupdrespin3").val(r3no);
                long = $("#txtupdrespin3").val().length;
                $("#lblupdrespin3").html(long);
                ...
                $("#ctr_txtupdretro").val(0);
                $("#ctr_selupdtema").val(0);
                $("#ctr_txtupdrespin1").val(0);
                $("#ctr_txtupdrespin2").val(0);
                $("#ctr_txtupdrespin3").val(0);
            ...
            function modificar() {
                ...
                let idgra = $("#txtupdidgra").val();
                let idpen = $("#txtupdidpen").val();
                let idtp = $("#txtupdidtp1").val();
                let pregunta = $("#txtupdpreg").val();
                pregunta = pregunta.replace(" ", "_");
                pregunta = pregunta.replace("+", "|");
                let r1ok = $("#txtupdresp").val();
                r1ok = r1ok.replace(" ", "_");
                let idtema = $("#selupdtema").val();
                let retro = $("#txtupdretro").val();
                retro = retro.replace(" ", "_");
                
                let r1no = $("#txtupdrespin1").val();
                r1no = r1no.replace(" ", "_");
                let r2no = $("#txtupdrespin2").val();
                r2no = r2no.replace(" ", "_");
                let r3no = $("#txtupdrespin3").val();
                r3no = r3no.replace(" ", "_");
                
                let tema = $("#selupdtema").val();
                let ntema = $("#txtupdotro").val();
                ntema =ntema.replace(" ", "_");
                //alert("ntema= " + ntema + " idgra= " + idgra + " idpen= " + idpen);
                ...
                if(tema == 2) {
                    ...
                    $.ajax({
                        ...
                        success:function(r) {
                            //alert(r);
                            $("#idn_tema").val(r);
                            modificar_preg(idgra, idpen, idtp, pregunta, r1ok, r, retro, idpregunta, r1no, r2no, r3no);
                        }
                    });
                }
                else if(tema == 1) {
                    ...
                    modificar_preg(idgra, idpen, idtp, pregunta, r1ok, idtema, retro, idpregunta, r1no, r2no, r3no);
                }
            }
            
            function modificar_preg(idgra, idpen, idtp, pregunta, r1ok, idtema, retro, idpreg, r1no, r2no, r3no) {
                //alert(idtp);
                if(idtp == 3) {
	...
	<body id="bodyadm" class="cbp-spmenu-push">
               		...
               		<div class="charts">		
               		 	<div class="mid-content-top charts-grids">	
                                    ...
                                    <div id="cont">
                            			...
                            			<div id="div2">
                            				<fieldset id="fl1">
                            				    <legend><h3>BANCO DE PREGUNTAS <i class="fa fa-arrow-right "></i> PREGUNTA DE SELECCION SENCILLA</h3>
                            				        <img id="imgt" src="../../images/preguntas/ss_2.png" width="153"/>
                            				    </legend>
                            				        ...
                            				        <tbody>
                            				            <tr>
                            				                ...
                            				                <td>
														        ...
														        <input type="hidden" id="txtctrpen" name="txtctrpen" value="NA"/>
                            				                </td>
                            				            </tr>
                            				            <tr>
                            				                <td colspan="3">
          ...
          <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">NUEVA PREGUNTA DE SELECCION SENCILLA</h5>
              ...
              <div class="modal-body">
                ...
                <label>* Ingrese segunda opción incorrecta <input type="text" class="controlcampo" style="width: 20px" id="ctr_txtrespin2" value="1"/> (600 | </label>
                <label id="lblrespin2">0</label><label>)</label>
                <input type="text" id="txtrespin2" name="txtrespin2" class="form-control" onkeyup="mayus(this, 'txtrespin2', 'Opción 2 incorrecta');" maxlength="600" required/>
                
                <label>* Ingrese tercera opción incorrecta <input type="text" class="controlcampo" style="width: 20px" id="ctr_txtrespin3" value="1"/> (600 | </label>
                <label id="lblrespin3">0</label><label>)</label>
                <input type="text" id="txtrespin3" name="txtrespin3" class="form-control" onkeyup="mayus(this, 'txtrespin3', 'Opción 3 incorrecta');" maxlength="600" required/>
                ...
                <input type="file" id="adjunto" name="adjunto" accept=".jpg,.png,.jpeg" class="btn btn-lg btn-info">
              </div>
        ...
        <div class="modal fade" id="modal_editar_preg" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">EDITAR PREGUNTA DE SELECCION SENCILLA</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
              <div class="modal-body">
                ...
                <label>* Pregunta <input type="text" class="controlcampo" style="width: 20px" id="ctr_txtupdpreg" value="1"/> (1000 | </label>
                ...
                <label>* Primera opción incorrecta <input type="text" class="controlcampo" style="width: 20px" id="ctr_txtupdrespin1" value="1"/> (600 | </label>
                ...
                <label>* Segunda opción incorrecta <input type="text" class="controlcampo" style="width: 20px" id="ctr_txtupdrespin2" value="1"/> (600 | </label>
                <label id="lblupdrespin2">0</label><label>)</label>
                <input type="text" id="txtupdrespin2" name="txtupdrespin2" class="form-control" onkeyup="mayus(this, 'txtupdrespin2', 'Opción 2 incorrecta');" maxlength="600" required/>
                
                <label>* Tercera opción incorrecta <input type="text" class="controlcampo" style="width: 20px" id="ctr_txtupdrespin3" value="1"/> (6.0 | </label>
                <label id="lblupdrespin3">0</label><label>)</label>
                <input type="text" id="txtupdrespin3" name="txtupdrespin3" class="form-control" onkeyup="mayus(this, 'txtupdrespin3', 'Opción 3 incorrecta');" maxlength="600" required/>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <input type="file" id="updadjunto" name="updadjunto" accept=".jpg,.png,.jpeg" class="btn btn-lg btn-info">
                    </div>
                    <div class="col-lg-4">
