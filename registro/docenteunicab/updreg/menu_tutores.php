  ...
  $sql_menu="SELECT distinct e.id, e.apellidos, e.nombres, g.id as id_grado, g.grado 
      FROM grados g, tbl_empleados e, tbl_carga_profesor cp 
  ...
  <div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
      ...
      <nav class="navbar navbar-inverse">
          <div class="navbar-header">
            ...
            <h1><a class="navbar-brand" href="../index.php"><img src="../../images/logo_thrive_f2.png" width="80%" /></a></h1>
          </div>
              ...
              <li class="treeview">
                ...
                <ul class="treeview-menu">
				  ...
				  <?php
    				    ...
    				    if($perfil != "PR") {
				  ?>
                  <li><a href="ranking_getdat.php"><i class="fa fa-sort-amount-desc"></i> <span>Ranking</span></a></li>
                  <?php
    				    }
                  ?>
                </ul>
