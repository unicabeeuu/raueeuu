<?php
	...
	set_time_limit(300);
	//https://unicab.org/registro/docenteunicab/updreg/estudiante_getdat_prueba.php?buscar=arevalo%20rodriguez&estado=activo
	//https://unicab.org/registro/docenteunicab/updreg/estudiante_getdat_prueba.php?buscar=arenas%20duque&estado=activo
	
//if (isset($_SESSION['uniprofe']) || isset($_SESSION['unisuper']) || isset($_SESSION['admin_unicab'])) {
	$fila = 0;
	
	$nom = strtoupper($_REQUEST['buscar']);
	//echo $nom;
...
<html>
	<head><meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
		...
		<script>
    			...
    			if(res.lbls.length == 1) {
            	    ...
            	    var datos = {
                        ...
                        datasets : [
                            ...
                            {label : "Cal. Min.", backgroundColor : "rgba(255,0,0,0.9)", data : [3.5,3.5], type: 'line', fill : false, borderColor : "#FF0000", order: 3}
                        ]
                    };
            	}
    			    ...
    			    var datos = {
                        ...
                        datasets : [
                            ...
                            {label : "Cal. Min.", backgroundColor : "rgba(255,0,0,0.9)", data : [3.5,3.5,3.5], type: 'line', fill : false, borderColor : "#FF0000", order: 3}
                        ]
                    };
            	}
    			    ...
    			    var datos = {
                        ...
                        datasets : [
                            ...
                            {label : "Cal. Min.", backgroundColor : "rgba(255,0,0,0.9)", data : [3.5,3.5,3.5,3.5], type: 'line', fill : false, borderColor : "#FF0000", order: 3}
                        ]
                    };
            	}
    			    ...
    			    var datos = {
                        ...
                        datasets : [
                            ...
                            {label : "Cal. Min.", backgroundColor : "rgba(255,0,0,0.9)", data : [3.5,3.5,3.5,3.5,3.5], type: 'line', fill : false, borderColor : "#FF0000", order: 3}
                        ]
                    };
            	}
    			    ...
    			    var datos = {
                        ...
                        datasets : [
                            ...
                            {label : "Cal. Min.", backgroundColor : "rgba(255,0,0,0.9)", data : [3.5,3.5,3.5,3.5,3.5,3.5], type: 'line', fill : false, borderColor : "#FF0000", order: 3}
                        ]
                    };
            	}
            	    ...
            	    var datos = {
                        ...
                        datasets : [
                            ...
                            {label : "Cal. Min.", backgroundColor : "rgba(255,0,0,0.9)", data : [3.5,3.5,3.5,3.5,3.5,3.5,3.5], type: 'line', fill : false, borderColor : "#FF0000", order: 3}
                        ]
                    };
            	}
            	    ...
            	    var datos = {
                        ...
                        datasets : [
                            ...
                            {label : "Cal. Min.", backgroundColor : "rgba(255,0,0,0.9)", data : [3.5,3.5,3.5,3.5,3.5,3.5,3.5,3.5], type: 'line', fill : false, borderColor : "#FF0000", order: 3}
                        ]
                    };
            	}
    			//$("#divresul").html(data);
            ...
            //*******************************************************************************
            //(4)
            function ver_cal_enfasis(id_est, id_gra) {
                $.ajax({
            		type:"POST",
            		url:"buscar_notas_enfasis.php",
            		data:"idest=" + id_est + "&idgra=" + id_gra,
            		success:function(r) {
            			mostrar_notas_enfasis(r);
            		}
            	});
            }
            //*******************************************************************************
    			...
    			if(res.p1[0] == undefined) {
                    ...
                    window.bar = new Chart(canvas, {
                        ...
                        options : {
                            ...
                            title : {
                                display : true,
                                text : "CALIFICACIONES EN REGISTRO ENFASIS",
                                fontSize : 14
                            }
                        }
                    });
				...
				<table>
					<tbody>
						...
						<tr>
							<td>
								<fieldset>
									<legend>Base de Datos de Estudiantes con Nombre o Apellido: <?php echo $nom; ?>
									</legend>
									<?php
									...
									<table border="1px" class="table" id="tblest">
										...
										<tr class="GridviewScrollItem">
											<td class="tdelargo"><?php echo $row['nombre'];?></td>
											<td class="tdlargo"><?php echo $row['tipo_documento'];?></td>
