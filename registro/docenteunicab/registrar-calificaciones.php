				...
				<div class="tables">
					...
					<div class="panel-body widget-shadow">
						<div class="panel-group" id="accordion">
							...
							$auto=0;
							$buscar_estudiantes="SELECT DISTINCT tbl_estudiantes.id AS id_estudiante, tbl_estudiantes.apellidos, tbl_estudiantes.nombres, tbl_grados.id AS id_grado, tbl_grados.grado, materias.Id AS id_materia, materias.materia, tbl_matriculas.idMatricula, tbl_matriculas.estado FROM (tbl_grados INNER JOIN (materias INNER JOIN carga_profesor ON materias.Id = carga_profesor.id_materia) ON tbl_grados.id = carga_profesor.id_grado) INNER JOIN (tbl_estudiantes INNER JOIN tbl_matriculas ON tbl_estudiantes.id = tbl_matriculas.id_estudiante) ON tbl_grados.id = tbl_matriculas.id_grado where tbl_grados.id=".$grado." and materias.Id=".$materia."  and tbl_matriculas.estado='activo' ORDER BY apellidos ASC";
