...
$buscar_grado="SELECT DISTINCT tbl_matriculas.id_grado, tbl_grados.grado FROM tbl_matriculas INNER JOIN tbl_grados ON tbl_matriculas.id_grado=tbl_grados.id INNER JOIN tbl_estudiantes on tbl_matriculas.id_estudiante=tbl_estudiantes.id where tbl_estudiantes.id=".$id_estudiante." and tbl_matriculas.estado='activo'";
	$sqlNotas="SELECT DISTINCT tbl_grados.grado, materias.materia, materias.pensamiento, tbl_empleados.apellidos, tbl_empleados.nombres, tbl_estudiantes.id, tbl_matriculas.estado FROM materias INNER JOIN ((tbl_grados INNER JOIN (tbl_estudiantes INNER JOIN tbl_matriculas ON tbl_estudiantes.id = tbl_matriculas.id_estudiante) ON tbl_grados.id = tbl_matriculas.id_grado) INNER JOIN (tbl_empleados INNER JOIN carga_profesor ON tbl_empleados.id = carga_profesor.id_profesor) ON tbl_grados.id = carga_profesor.id_grado) ON materias.Id = carga_profesor.id_materia WHERE tbl_estudiantes.id='".$id_estudiante."' and tbl_matriculas.estado='activo' ORDER BY materias.pensamiento asc";
