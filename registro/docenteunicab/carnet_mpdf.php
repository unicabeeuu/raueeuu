<?php
	...
	//echo __DIR__ . "/updreg/mpdf8/vendor/mpdf/mpdf/ttfonts";
	...
	$mpdf = new \Mpdf\Mpdf(["format" => "C1", "margin_left" => 0, "margin_right" => 0, "margin_top" => 0, "margin_bottom" => 0, 
							"fontDir" => array_merge($fontDirs, [
								__DIR__ . "/updreg/mpdf8/vendor/mpdf/mpdf/ttfonts",
							]),
							"fontdata" => $fontData + [
								"futuramdbtmedium" => [
									"R" => "FuturaMdBTMedium.ttf",
									"B" => "FuturaMdBTBold.ttf",
								]
							],
							"default_font" => "futuramdbtmedium"]);
    ...
    $content .= '<style>';
		...
		//$content .= '@font-face {font-family: "FuturaMdBTMedium"; src: url("updreg/mpdf8/vendor/mpdf/mpdf/ttfonts/FuturaMdBTMedium.ttf") format("TrueType");}';
		...
		$content .= '#tbldatos {width: 100%;}';
		$content .= '.tdtb {width: 100%;}';
		//$content .= '#tbldatos tbody td {border: 1px solid black;}';
        ...
        //$content .= '#div4 {width: 1004px; height: 650px; background-image: url("carnets/img/posterior_2023_1.jpg"); background-repeat: no-repeat; background-size: cover;  margin-left: 100px;}';
        ...
        $content .= '.nom {font-family: "HelveticaBold"; font-weight: bold; font-size: 18pt; color: black;}';
        $content .= '.nom1 {font-family: "futuramdbtmedium"; font-weight: bold; font-size: 22pt; color: #253668; text-transform: capitalize}';
		$content .= '.nom2 {font-family: "futuramdbtmedium"; font-weight: bold; font-size: 18pt; color: #253668;}';
		//$content .= '.nom3 {font-family: "FuturaMdBTBold"; font-weight: bold; font-size: 22pt; color: white; text-align: center; text-transform: uppercase;}';
		$content .= '.nom3 {font-family: "FuturaMdBTBold"; font-weight: bold; font-size: 22pt; color: white; text-transform: uppercase;}';
		$content .= '.nom31 {font-family: "FuturaMdBTBold"; font-weight: bold; font-size: 22pt; color: white;}';
		$content .= '.nom4 {font-family: "futuramdbtmedium"; font-weight: bold; font-size: 18pt; color: transparent;}';
        $content .= '#imgqr {margin-bottom: 10px;}';
		$content .= '#imglogocarnet {margin-left: 80px;}';
        //$content .= 'div {border: 2px solid black;}';
        $content .= 'p {line-height: 90%;}';
		$content .= '.lblmargin {color: white;}';
		$content .= '.centrado {text-align: center;}';
		//$content .= '.centrado p {margin-left: 500px;}';
		$content .= '.naranja {color: #FF9805;}';
		//$content .= '.naranja {color: orange;}';
        //$content .= '#divcontxt {margin-top: 335px;}';
		$content .= '#divcontxt {margin-top: 500px;}';
        //$content .= '#divtxt {width: 620px; height: 200px; float: left; margin-left: 10px;  text-align: center;}';
		$content .= '#divtxt {float: left; margin-left: 150px;}';
        $content .= '#divqr {width: 200px; height: 200px; float: left; margin-left: 350px;}';
		$content .= '#divpietxt {text-align: center; margin-top: 150px;}';
    $content .= '</style>';
    $content .= '</head><body>';
    $content1 = "";
    ...
    while($row_carnets = $exe_carnets->fetch_assoc()) {
		...
		$nombre_completo = str_replace(" ", "_", $nombre_completo);
        ...
        if($tipo_c == "EST") {
            $contenido = 'Est='.$row_carnets['nombres']." ".$row_carnets['apellidos'].'|Grado='.$row_carnets['grado'].'|Acud='.$row_carnets['acudiente_1'].'|Cel=(57) '.$row_carnets['telefono_acudiente_1'].'|Email='.$row_carnets['email_acudiente_1'].'|Dir='.$row_carnets['direccion'];
        }
        else {
        ...
        $ct_carnet = 0;
        $sql_val_carnet = "SELECT COUNT(1) ct FROM tbl_carnets WHERE id_emp_est = $id1 AND tipo = '$tipo_c' AND a = $fanio";
        ...
        if($ct_carnet > 0 ) {
            ...
            $sql_ins_carnet = "INSERT INTO tbl_carnets (id_emp_est, id_grado, tipo, ruta, ruta_codqr, a) VALUES ($id1, $idgra, '$tipo_c', 'NA', '$filename1', '$fanio')";
            ...
            $content1 .= '<div id="div2">';
                $content1 .= '<div id="divcontxt"></div>';
                    /*$content1 .= '<div id="divtxt">';
                        ...
                        $content1 .= '<p class="nom1">'.$tipo_doc1.' '.$row_carnets['n_documento'].'</p>';
						$content1 .= '<p class="nom1">RH: '.$row_carnets['estado'].'</p>';
                    ...
                    $content1 .= '<div id="divqr">';
                        ...
                        $content1 .= '<img id="imgqr" src="'.$filename.'" width="200px">';
                    $content1 .= '</div>';					
                //$content1 .= '</div>';
					$content1 .= '<div id="divpietxt">';
						$content1 .= '<p class="nom1">'.$row_carnets['grado'].' '.$row_carnets['grupo'].'</p>';
					$content1 .= '</div>';*/
					
				$content1 .= '<div id="divtable">';
					$content1 .= '<table id="tbldatos"><tbody>';
					//$content1 .= '<tr><td width="40px"></td><td colspan="3" class="centrado"><p class="nom1">'.$nombres.'</p></td><td width="40px"></tr>';
					$content1 .= '<tr><td width="40px"></td><td colspan="3"><table class="tdtb"><tbody><tr><td width="150px"></td><td><p class="nom1">'.$nombres.'</p></td><td width="40px"></td></tr></tbody></table></td><td width="40px"></tr>';
					$content1 .= '<tr><td width="40px"></td><td colspan="3"><table class="tdtb"><tbody><tr><td width="150px"></td><td><p class="nom1">'.$apellidos.'</p></td><td width="40px"></td></tr></tbody></table></td><td width="40px"></tr>';
					//$content1 .= '<tr><td width="40px"></td><td colspan="3" class="centrado"><p class="nom1">'.$apellidos.'</p></td><td width="40px"></tr>';
					//$content1 .= '<tr><td width="40px"><td colspan="3" class="centrado"><p class="nom2"><span class="naranja">'.$tipo_doc1.'</span> '.$row_carnets['n_documento'].'</p></td><td width="40px"></tr>';
					$content1 .= '<tr><td width="40px"></td><td colspan="3"><table class="tdtb"><tbody><tr><td width="150px"></td><td><p class="nom2"><span class="naranja">'.$tipo_doc1.'</span> '.$row_carnets['n_documento'].'</p></td><td width="40px"></td></tr></tbody></table></td><td width="40px"></tr>';
					//$content1 .= '<tr><td width="40px"><td colspan="3" class="centrado"><p class="nom2"><span class="naranja">RH: </span>'.$rh.'</p></td><td width="40px"></tr>';
					$content1 .= '<tr><td width="40px"></td><td colspan="3"><table class="tdtb"><tbody><tr><td width="150px"></td><td><p class="nom2"><span class="naranja">RH: </span>'.$rh.'</p></td><td width="40px"></td></tr></tbody></table></td><td width="40px"></tr>';
					//$content1 .= '<tr><td width="40px"></td><td colspan="3"><p class="nom2">'.$row_carnets['grado'].' '.$row_carnets['grupo'].'</p></td><td width="40px"></tr>';
					//$content1 .= '<tr><td width="40px"></td><td colspan="3"><p class="nom4">'.$row_carnets['grado'].' '.$row_carnets['grupo'].'</p></td><td width="40px"></tr>';
					//$content1 .= '<tr><td width="40px"><td><img id="imglogocarnet" src="carnets/img/logo_carnet_2024_1.jpg"></td><td width="20px"></td><td><img id="imgqr" src="'.$filename1.'" width="200px"></td><td width="40px"></tr>';
					$content1 .= '<tr><td width="40px"><td width="300px"></td><td width="20px"></td><td><img id="imgqr" src="'.$filename1.'" width="200px"></td><td width="40px"></tr>';
					//$content1 .= '<tr><td width="40px"></td><td colspan="3"><p class="nom4">'.$row_carnets['grupo'].'</p></td><td width="40px"></tr>';
					//$content1 .= '<tr><td width="40px"></td><td colspan="3"><p class="nom4">'.$row_carnets['grupo'].'</p></td><td width="40px"></tr>';
					$content1 .= '<tr><td width="40px"></td><td class="nom31"><p>Grado</p></td><td colspan="3" ></tr>';
					$content1 .= '<tr><td width="40px"></td><td class="nom3"><p>'.$row_carnets['grado'].' '.$row_carnets['grupo'].'</p></td><td colspan="3" ></tr>';
        ...
        <table border="1">
            ...
            ?>
                <tr>
                    ...
                    <td><a href="<?php echo $row_cu['ruta']; ?>" target="_blank"><?php echo $row_cu['ruta']; ?></a></td>
