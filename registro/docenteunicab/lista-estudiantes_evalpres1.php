<?php
    ...
    //https://unicab.org/registro/docenteunicab/lista-estudiantes_evalpres1.php?idest=1908
...
if (isset($_SESSION['unisuper']) || isset($_SESSION['uniprofe'])) {
	...
	//Se busca el mayor año; es decir la última evaluación
	$ultimaevaluacion = $ultimaevaluacionzz;
	$sql_ultimoaño = "SELECT MAX(a) a FROM tbl_respuestas WHERE identificacion = (SELECT n_documento FROM estudiantes WHERE id = $idest)";
	$exe_ultimoaño = mysqli_query($conexion,$sql_ultimoaño);
	while ($row_ultimoaño = mysqli_fetch_array($exe_ultimoaño)) {
		$ultimaevaluacion = $row_ultimoaño['a'];
	}
	...
	if($idest < 0) {
		...
		AND e.id = $idest  AND r.a = $ultimaevaluacion";
	}
	else {
		...
		WHERE id_estudiante = $idest AND estado IN ('pre_solicitud', 'solicitud', 'activo', 'aprobado', 'reprobado') 
		...
		//Esto es para el proceso de evaluación del proximo año, a partir de octubre
		$sql_n = "SELECT DISTINCT e.id, e.nombres, e.apellidos, e.n_documento, g.grado, g.id id_grado 
		FROM estudiantes e, tbl_pre_matricula m, grados g, tbl_respuestas r 
		WHERE e.n_documento = m.documento_est AND m.id_grado = g.id AND e.n_documento = r.identificacion AND e.id = $idest AND r.a = $ultimaevaluacion";
	}
    ...
    AND r.a = $ultimaevaluacion AND r.identificacion = '$documento' 
    ...
    AND r.resultado = 'NO' AND r.identificacion ='$documento' AND r.a = $ultimaevaluacion AND r.id_materia = 5";
    ...
    FROM tbl_respuestas r, tbl_preguntas p 
    WHERE r.id_pregunta = p.id 
    AND r.resultado = 'NO' AND r.identificacion ='$documento' AND r.a = $ultimaevaluacion AND r.id_materia = $array_materias_final[2]";
	
	//Se hace la consulta de las recomendaciones para bioético
    $sql_retro_bio_ct = "SELECT COUNT(1) ct 
    FROM tbl_respuestas r, tbl_preguntas p 
    WHERE r.id_pregunta = p.id 
    AND r.resultado = 'NO' AND r.identificacion ='$documento' AND r.a = $ultimaevaluacion AND r.id_materia = 1";
    ...
    FROM tbl_respuestas r, tbl_preguntas p 
    WHERE r.id_pregunta = p.id 
    AND r.resultado = 'NO' AND r.identificacion ='$documento' AND r.a = $ultimaevaluacion AND r.id_materia = $array_materias_final[0]";
    
    //Se hace la consulta de las recomendaciones para social
    $sql_retro_soc_ct = "SELECT COUNT(1) ct 
    FROM tbl_respuestas r, tbl_preguntas p 
    WHERE r.id_pregunta = p.id 
    AND r.resultado = 'NO' AND r.identificacion ='$documento' AND r.a = $ultimaevaluacion AND r.id_materia = 4";
    ...
    FROM tbl_respuestas r, tbl_preguntas p 
    WHERE r.id_pregunta = p.id 
    AND r.resultado = 'NO' AND r.identificacion ='$documento' AND r.a = $ultimaevaluacion AND r.id_materia = $array_materias_final[1]";
    
    //Se hace la consulta de las recomendaciones para español
    $sql_retro_esp_ct = "SELECT COUNT(1) ct 
    FROM tbl_respuestas r, tbl_preguntas p 
    WHERE r.id_pregunta = p.id 
    AND r.resultado = 'NO' AND r.identificacion ='$documento' AND r.a = $ultimaevaluacion AND r.id_materia = 6";
    ...
    FROM tbl_respuestas r, tbl_preguntas p 
    WHERE r.id_pregunta = p.id 
    AND r.resultado = 'NO' AND r.identificacion ='$documento' AND r.a = $ultimaevaluacion AND r.id_materia = $array_materias_final[3]";
    
    //Se hace la consulta de las recomendaciones para inglés
    $sql_retro_ing_ct = "SELECT COUNT(1) ct 
    FROM tbl_respuestas r, tbl_preguntas p 
    WHERE r.id_pregunta = p.id 
    AND r.resultado = 'NO' AND r.identificacion ='$documento' AND r.a = $ultimaevaluacion AND r.id_materia = 7";
    ...
    FROM tbl_respuestas r, tbl_preguntas p 
    WHERE r.id_pregunta = p.id 
    AND r.resultado = 'NO' AND r.identificacion ='$documento' AND r.a = $ultimaevaluacion AND r.id_materia = $array_materias_final[4]";
    
    //Se hace la consulta de las recomendaciones para tecnológico
    $sql_retro_tec_ct = "SELECT COUNT(1) ct 
    FROM tbl_respuestas r, tbl_preguntas p 
    WHERE r.id_pregunta = p.id 
    AND r.resultado = 'NO' AND r.identificacion ='$documento' AND r.a = $ultimaevaluacion AND r.id_materia = 9";
    ...
    FROM tbl_respuestas r, tbl_preguntas p 
    WHERE r.id_pregunta = p.id 
    AND r.resultado = 'NO' AND r.identificacion ='$documento' AND r.a = $ultimaevaluacion AND r.id_materia = $array_materias_final[5]";
    
    //Se hace la consulta de las recomendaciones para física
    $sql_retro_fis_ct = "SELECT COUNT(1) ct 
    FROM tbl_respuestas r, tbl_preguntas p 
    WHERE r.id_pregunta = p.id 
    AND r.resultado = 'NO' AND r.identificacion ='$documento' AND r.a = $ultimaevaluacion AND r.id_materia = 11";
    ...
    FROM tbl_respuestas r, tbl_preguntas p 
    WHERE r.id_pregunta = p.id 
    AND r.resultado = 'NO' AND r.identificacion ='$documento' AND r.a = $ultimaevaluacion AND r.id_materia = $array_materias_final[6]";
    ...
    AND a = $ultimaevaluacion GROUP BY identificacion, id_materia";
    //echo $sql_ctok;
                                ...
                                <div class="form-group" style="background: #F1F1F2;">
                                    <?php 
							        	...
							        	while ($fila = mysqli_fetch_array($peticion)){
							        	    ...
							        	    $tbl_pregunta .= '<tr style="background: #1d2b2e; color: #F1F1F2;"><td style="color: #1d2b2e; width: 100px;">Answer</td><td style="vertical-align: middle;">Tu respuesta: '.$fila['respuesta'].'</td><td style="text-align: center;"><img src="'.$img_resul.'" width="100px"/></td></tr>';
