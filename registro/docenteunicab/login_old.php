...
<html>
<head>
<title>Unicab Registro Académico - Docentes</title>
...
<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page login-page ">
				<h2 class="title1">Registro Académico <strong>-</strong> Docentes</h2>
			<div class="widget-shadow">
				<div class="login-body">
					<form action="../adminunicab/php/loginProfesor.php" method="post" onsubmit="javascript:return Validar(this);">
