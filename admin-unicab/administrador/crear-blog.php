<?php 
	...
	if (isset($_SESSION['admin_unicab'])) {
		...
		while ($rowAdmin=mysqli_fetch_array($exeAdministrador)) {
			$IdAdministrador=$rowAdmin['id'];
			$Apellidos=$rowAdmin['apellidos'];
			$Nombres=$rowAdmin['nombres'];
		}
?>
<!DOCTYPE HTML>
<html>
           	...
           	<div id="page-wrapper">
				<div class="forms">
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						...
						<div class="form-body">
							<form action="php/crearBlog.php" method="POST" id="form" name="form" enctype="multipart/form-data">
								...
								<input type="hidden" class="form-control" name="IdEmp" value="<?php echo $IdAdministrador;?>" readonly>
