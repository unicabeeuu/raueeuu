		...
		<div id="page-wrapper">
			<div class="main-page">
				...
				<div class="forms">
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						<div class="form-body">
							<form action="php/crearDirectorio.php" method="POST" id="form" name="form" onsubmit="javascript:return Validar(this);">
								
                                <div class="form-group"> 
									<label for="nombreD">Nombre</label> 
									<input type="text" class="form-control" id="nombreD" name="nombreD" placeholder="Ingrese nombre de la persona" autofocus="" onblur="javascript:Validar();">
								</div>

								<div class="form-group"> 
									<label for="dependenciaD">Dependencia</label> 
									<input type="text" class="form-control" id="dependenciaD" name="dependenciaD" placeholder="Ingrese depedencia de trabajo" onblur="javascript:Validar();">
								</div>

								<div class="form-group"> 
									<label for="correoD">Correo</label> 
									<input type="text" class="form-control" id="correoD" name="correoD" placeholder="Ingrese correo electrónico">
								</div>

								<div class="form-group"> 
									<label for="skypeD">Skype</label> 
									<input type="text" class="form-control" id="skypeD" name="skypeD" placeholder="Ingrese Skype">
								</div>

								<div class="form-group"> 
									<label for="telefonoD">Teléfono</label> 
									<input type="text" class="form-control" id="telefonoD" name="telefonoD" placeholder="Ingrese Teléfono o Número de contacto">
								</div>

								<div class="form-group"> 
									<label for="whatD">Número WhatsApp</label> 
									<input type="text" class="form-control" id="whatD" name="whatD" placeholder="Ingrese Número de WhatsApp">
								</div>

								<div class="form-group"> 
									<label for="cargoD">Cargo</label> 
									<input type="text" class="form-control" id="cargoD" name="cargoD" placeholder="Ingrese cargo de trabjo">
								</div>
