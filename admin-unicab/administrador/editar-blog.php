<?php 
	...
	if (isset($_SESSION['admin_unicab'])) {
		...
		$sql_buscarB="SELECT * FROM `blog` WHERE `IdBlog`=".$_GET['id']."";
		$exe_buscarB=mysqli_query($conexion,$sql_buscarB);

		while ($rowBlog=mysqli_fetch_array($exe_buscarB)) {
			$idBlog=$rowBlog['IdBlog'];
			$titulo=$rowBlog['TituloB'];
			$descripcion=$rowBlog['DescripcionB'];
			$imagen=$rowBlog['ImagenB'];
			$categoria=$rowBlog['CategoriaB'];
			$idAdministrador=$rowBlog['IdAdministrador'];
		}
				...
				<div class="forms">
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						<div class="form-title">
							<h4>Editar Post: <?php echo $titulo; ?></h4>	
						</div>
					</div>
				</div>
				<div class="forms">
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						<div class="form-body">
							<form action="php/actualizarBlog.php" method="POST" id="form" name="form" onsubmit="javascript:return Validar(this);"  enctype="multipart/form-data">

								<div class="form-group"> 
									<label for="TituloB">Título</label> 
									<input type="text" class="form-control" id="TituloB" name="TituloB" placeholder="Ingrese nombre del evento" value="<?php echo $titulo; ?>" onblur="javascript:Validar();">
								</div>

								<div class="form-group"> 
									<label for="DescripcionB">Descripción</label> 
									<textarea id="DescripcionB" name="DescripcionB" rows="20" class="form-control1" placeholder="Descripción o información del evento"  onblur="javascript:Validar();"><?php echo $descripcion;?></textarea>
								</div>	
								...
								<div id="imagen_nueva" style="display: none;">
									<div class="form-group"> 
										<label for="ImagenB">Imagen</label> 
										<input type="file" class="form-control" id="ImagenB" name="ImagenB">
										<p id="texto"> </p><br/>   	
								...
								<div id="categoria_nueva" style="display: none;">
									<div class="form-group"> 
										<label for="CategoriaB">Categoría</label> 
										<select id="CategoriaB" name="CategoriaB" class="form-control1">
											<option value="0">--- SELECCIONE ---</option>
										<option value="Maestros Mediadores">Maestros Mediadores</option>
										<option value="Padres de Familia">Padres de Familia</option>
                                        <option value="Estudiantes">Estudiantes</option>
                                        <option value="Equipo de Psicología">Equipo de Psicología</option>
										</select>
									</div>
								</div>	
								...
								<input type="hidden" class="form-control" name="IdBlog" value="<?php echo $idBlog;?>" readonly>
