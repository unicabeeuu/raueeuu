...
<html>
	<head><meta http-equiv="Content-Type" content="text/html; charset=gb18030">
		<META HTTP-EQUIV="Refresh" CONTENT="0; URL=../lista-baner.php">
...
//INSERTAMOS EL COMENTARIO
		...
		try {
			$sql_actualizar="UPDATE `banner` SET `titulo`='".$titulo1."',`subtitulo`='".$titulo2."',`titulo2`='".$subtitulo1."',`subtitulo2`='".$subtitulo2."',`descripcion`='".$descripcion."',`imagen`='".$destino."',`boton1`='".$boton1."',`texto1`='".$texto1."',`boton2`='".$boton2."',`texto2`='".$texto2."' WHERE `id`=".$idBanner."";
