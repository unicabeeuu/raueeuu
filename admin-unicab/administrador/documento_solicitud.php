				...
				<div class="forms">
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						<div class="form-title">
							<h4>Documento que envío solicitud de matrícula:</h4>	
						</div>
					</div>
				</div>
				<div class="forms">
					<form action="documento_solicitud1.php" method="POST" id="form" name="form" enctype="multipart/form-data">
						<div class="form-grids row widget-shadow azul1" data-example-id="basic-forms"> 
							<div class="form-group col-lg-6 text-left">
								<label id="lblbuscar">Año de solicitud:</label>
							</div>
							<div class="form-group col-lg-6 text-left azul1">
								<input type="number" class="" id="año" name="año" width="300px" >
							</div>
							...
							<div class="form-group col-lg-6 text-left azul1">
								<input type="text" class="" id="documento" name="documento" width="300px" >
								
								<!--<button class="btn btn-success" >Enviar Contrato y Link de Matrícula</button>-->
								<input type="submit" id="btnsubmit" class="btn btn-success" value="Registrar Documento"/>
							</div>
						</div>
					</form>
				</div>
