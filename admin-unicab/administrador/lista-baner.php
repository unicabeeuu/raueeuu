					        	...
					        	<?php 
					        		...
					        		while ($rowBanner=mysqli_fetch_array($exe_banner)) {
					        			...
					        			<tr>
					        				...
					        				<td><center>
					        				<a href='editar-banner.php?id=".$rowBanner['id']."'><i class='fa fa-pencil' aria-hidden='true'> Editar</i></a> | 
					        				<a href='php/eliminarBanner.php?id=".$rowBanner['id']."'><i class='fa fa-trash' aria-hidden='true'> Borrar</i></a></center> 
					        				</td>
					        			</tr>
					        			";
					        		}
