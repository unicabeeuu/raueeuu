<?php 
	...
	if (isset($_SESSION['admin_unicab'])) {
		...
		$sql_banner="SELECT * FROM unicab_solutions.tbl_banner WHERE id=".$_GET['id']."";
		...
		while ($rowBanner = mysqli_fetch_array($exe_banner)) {
			...
			$estado=$rowBanner['estado'];
		}
		$urlImg = "../../unicab.solutions/".$imagenB;
		...
		<div id="page-wrapper">
			<div class="main-page">
				...
				<div class="forms">
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						<div class="form-body">
							<form action="php/actualizarBanner_us.php" method="POST" id="form" name="form" enctype="multipart/form-data">
								<!--  -->
								...
								<div class="form-group col-lg-12 text-left"> 
									<br><h3>Imagen banner: <?php echo $urlImg; ?></h3> 
									<hr>
								</div>
								...
								<div id="imagen_nueva" style="display: none;">
									<div class="form-group col-lg-12 text-left"> 
										<label for="ImagenN">Tamaño recomendado 1920*1079</label> 
