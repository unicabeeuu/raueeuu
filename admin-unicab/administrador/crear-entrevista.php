		...
		<div id="page-wrapper">
			<div class="main-page">
				...
				<div class="forms">
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						<div class="form-body">
							<form action="php/crearEntrevista.php" method="POST" id="form" name="form" enctype="multipart/form-data">

								
                                <div class="form-group col-lg-6 text-left"> 
                                <label for="documento">N. documento:</label>
									<input type="text" class="form-control" id="documento" name="documento" placeholder="Ingrese el número sin puntos" autofocus width="300px">
								</div>
                                ...
                                <label for="observaciones">Observaciones:</label>
									<textArea type="text" class="form-control" id="observaciones" name="observaciones" placeholder="Ingrese las observaciones generales"  width="300px" maxlength="512"></textArea>
								</div>
                    ...
                    <div class="alert alert-info" role="alert"><b>La entrevista se guardará con fecha:</b> <?php echo $fechaActual;?></div>
				</div>
			</div>
		</div>
		<!--footer-->
