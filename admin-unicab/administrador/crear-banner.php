					...
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						<div class="form-body">
							<?php 
								...
								$sql_total="SELECT COUNT(*) as 'total_banner' FROM `banner` WHERE estado = '1'";	
								...
								if ($totalBanner>=10) {
									...
									?>
									<form action="php/crearBanner.php" method="POST" id="form" name="form"  enctype="multipart/form-data">
								...
								<div class="form-group col-lg-12 text-left"> 
									...
									<textArea type="text" style="resize: none;" class="form-control" id="descripcion" rows="2" name="descripcion"></textArea>
								</div>
								...
								<div class="form-group col-lg-12 text-left"> 
									<label for="imagen">Tamaño recomendado 1920*1280</label> 
