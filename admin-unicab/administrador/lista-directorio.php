				...
				<div class="tables">
					<div class="panel-body widget-shadow">
						<table id="example" class="display" style="width:100%">
					        ...
					        <tbody>
					        	<?php 
					        		$sql_directorio="SELECT * FROM `directorio`";
					        		$exe_directorio=mysqli_query($conexion,$sql_directorio);
					        		while ($rowDirectorio=mysqli_fetch_array($exe_directorio)) {
					        			echo "
					        			<tr>
					        				<td>".$rowDirectorio['nombre']."</td>		
					        				<td>".$rowDirectorio['dependencia']."</td>		
					        				<td>".$rowDirectorio['correo']."</td>		
					        				<td>".$rowDirectorio['telefono_what']."</td>		
					        				<td><center>
					        				<a href='editar-directorio.php?id=".$rowDirectorio['id']."'><i class='fa fa-pencil' aria-hidden='true'> Editar</i></a> | 
					        				<a href='php/eliminarDirectorio.php?id=".$rowDirectorio['id']."'><i class='fa fa-trash' aria-hidden='true'> Borrar</i></a></center> 
					        				</td>
					        			</tr>
					        			";
					        		}
