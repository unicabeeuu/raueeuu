				...
				<div class="forms">
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						<div class="form-title">
							<h4>Resultado pre admisiones:</h4>	
						</div>
					</div>
				</div>
				<div class="forms">
						...
						<div class="form-group col-12 text-left">
    					    <?php
								if($resultados[0] == "CorreoOK") {
									echo "<h4>¡EL REGISTRO DE PRE-MATRÍCULA SE TERMINÓ CON ÉXITO!</h4><hr>";
									echo "<h4>¡CORREO ENVIADO CON ÉXITO a ".$resultados[1]."!</h4><hr>";
									//echo "<h5>¡Puede tardar entre 5 a 10 minutos en llegar... Por favor revisar el spam o correos no deseados!</h5><hr>";
									echo "<h4>Resumen:</h4><h4>Indicarle al acudiente que descargue el Contrato de Matrícula, lo diligencie y lo anexe cuando termine el proceso de matrícula.</h4>";
									echo "<h4>En el correo enviado encontrará un link para continuar con el proceso de matrícula. </h4><hr>";
									echo "<h4>Es probable que cuando le llegue el correo le aparezca una imagen como esta:</h4>";
									echo "<img src='https://unicab.org/assets/img/advertencia_correo1.png' width='700px'/>";
									echo "<h4>No haga clic en ninguna de las opciones de la imagen.</h4>";
									echo "<h4>Es un mensaje de advertencia que genera por seguridad nuestro hosting.</h4><hr>";
									echo "<h4 style='color: red;'>NOTA: El navegador Mozilla Firefox presenta problemas al descargar el contrato. Se recomienda utilizar otro.</h4><hr>";
									//echo "<a href='index.php' class='btn btn-brand smooth-scroll'>Página Principal</a>";
								}
								else if($resultados[0] == "CorreoError") {
									echo "<h4>¡SE PRESENTARON ERRORES EN EL PROCESO DE REGISTRO DE PRE-MATRÍCULA!</h4><hr>";
									echo "<h4>Resumen:</h4><h5>Error enviando correo al email registrado del acudiente.</h4>";
									echo "<hr>";
									echo "<p>Comunicate con Secretaría Académica e informa los datos ingresados para revisar.</p>";
									
								}
								else if($mensjae == "_") {
									echo "<h4>¡SE PRESENTARON ERRORES EN EL PROCESO!</h4><hr>";
									echo "<hr>";
									echo "<p>Comunicate con Secretaría Académica e informa los datos ingresados para revisar.</p>";								
								}
