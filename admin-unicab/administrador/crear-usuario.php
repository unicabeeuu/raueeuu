...
<body class="cbp-spmenu-push">
		...
		<div id="page-wrapper">
			<div class="main-page">
				...
				<div class="forms">
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						<div class="form-body">
							<form action="php/crearUsuario.php" method="POST" id="form" name="form" enctype="multipart/form-data" onsubmit="javascript:return Validar(this);">
								
                                <div class="form-group"> 
									<label for="NombreU">Nombre</label> 
									<input type="text" class="form-control" id="NombreU" name="NombreU" placeholder="Ingrese nombre" autofocus="" onblur="javascript:Validar();">
								</div>
   ...
   <script type="text/javascript">
   		function Validar(){
			...
			var perfil=document.getElementById('PerfilU').value;
			...
			if (pass=="") {
				$('#alert').html('<center><strong>Advertencia</strong> El password es Obligatorio</center>').slideDown(500);
				return false;
			}else{
		   		$('#alert').html('').slideUp(300);			
			}
