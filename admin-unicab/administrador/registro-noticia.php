		...
		<div id="page-wrapper">
			<div class="main-page">
				...
				<div class="forms">
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						<div class="form-body">
							<form action="php/crearNoticia.php" method="POST" id="form" name="form" onsubmit="javascript:return Validar(this);"  enctype="multipart/form-data">

								<div class="form-group"> 
									<label for="TituloN">Título</label> 
									<input type="text" class="form-control" id="TituloN" name="TituloN" placeholder="Ingrese nombre de la noticia" autofocus="" onblur="javascript:Validar();">
								</div>

								<div class="form-group"> 
									<label for="DescripcionN">Descripción</label> 
									<textarea id="DescripcionN" name="DescripcionN"  rows="20" class="form-control1" placeholder="Descripción o información de la noticia" onblur="javascript:Validar();"></textarea>
								</div>
								...
								<div class="form-group"> 
									...
									<select id="CategoriaN" name="CategoriaN" class="form-control1" onblur="javascript:Validar();">
								...
								<div class="form-group"> 
									...
									<input type="text" class="form-control" id="FuenteN" name="FuenteN" placeholder="Ingrese nombre o link de la fuente">
								</div> 
