...
<!--//Metis Menu -->
    ...
    <script>
        ...
        function mostrar_submit(id) {
            ...
            //let a = parseInt($("#ctr_obj_seg").val());
            let b = parseInt($("#ctr_desarrollo").val());
            let c = parseInt($("#ctr_avances").val());
            let d = parseInt($("#ctr_acc_est").val());
            let e = parseInt($("#ctr_acc_acu").val());
            let f = parseInt($("#ctr_compromisos").val());
            let g = parseInt($("#ctr_proc_post").val());
            let h = parseInt($("#ctr_obj_prox_seg").val());
            let i = parseInt($("#ctr_fecha_prox_seg").val());
            let j = parseInt($("#ctr_hora_prox_seg").val());
