...
<!--//Metis Menu -->
    ...
    <script>
        ...
        function buscar_inf() {
            ...
            $.ajax({
                type:"POST",
        		url:"informacion_preseg_getdat.php",
        		data:"buscar=" + buscar,
        		success:function(r) {
        		    ...
        		    if(res.estado == "SEGUIMIENTO_ABIERTO") {
        		        if(res.ct_cierre == 1) {
                		    ...
                		    $("#obj_seg").val(res.obj);
                		    $("#id_seg").val(res.id_seg);
                		    $("#id_val").val(res.id_val);
                		    $("#fecha_prog").val(res.fecha);
                		    $("#hora_prog").val(res.hora);
                		    ...
                		    //Se ponen los seguimientos anteriores
                		    ...
                		    for(obj of seguimientos) {
                		        tabla = tabla + "<tr>" +
                                    ...
                                    "onclick='enviardat(\"" + obj.desarrollo + "\",\"" + obj.fecha_real + "\",\"" + obj.hora_real + "\",\"" + obj.avances + "\",\"" + obj.acciones_est + 
        		        ...
        		        $("#lbldocumento").html("Este documento no tiene seguimientos abiertos.");
        		    }
        		}
        	});
        ...
        function mostrar_submit(id) {
            ...
            if(id == "desarrollo") {
                $("#lbldesarrollo").html(long);
                if(long > 500) {
                    $("#ctr_desarrollo").val(1);
                }
            }
            else if(id == "avances") {
                $("#lblavances").html(long);
                if(long > 500) {
                    $("#ctr_avances").val(1);
                }
            }
            else if(id == "acc_est") {
                $("#lblacc_est").html(long);
                if(long > 500) {
                    $("#ctr_acc_est").val(1);
                }
            }
            else if(id == "acc_acu") {
                $("#lblacc_acu").html(long);
                if(long > 500) {
                    $("#ctr_acc_acu").val(1);
                }
            }
            else if(id == "compromisos") {
                $("#lblcompromisos").html(long);
                if(long > 500) {
                    $("#ctr_compromisos").val(1);
                }
            }
            else if(id == "proc_post") {
                $("#lblproc_post").html(long);
                if(long > 500) {
                    $("#ctr_proc_post").val(1);
                }
            }
            else if(id == "obj_prox_seg") {
                ...
                if($(id_obj).val() == "NA") {
                    $("#fecha_prox_seg").val("0000-00-00");
                    $("#hora_prox_seg").val("00");
                    $("#ctr_fecha_prox_seg").val(0);
                    $("#ctr_hora_prox_seg").val(0);
                    $(".objna").hide();
                }
            ...
            //var a = parseInt($("#ctr_obj_seg").val());
            var b = parseInt($("#ctr_desarrollo").val());
            var c = parseInt($("#ctr_avances").val());
            var d = parseInt($("#ctr_acc_est").val());
            var e = parseInt($("#ctr_acc_acu").val());
            var f = parseInt($("#ctr_compromisos").val());
            var g = parseInt($("#ctr_proc_post").val());
            var h = parseInt($("#ctr_obj_prox_seg").val());
            var i = parseInt($("#ctr_fecha_prox_seg").val());
            var j = parseInt($("#ctr_hora_prox_seg").val());
            //alert("a=" + a + " b=" + b + " c=" + c + " d=" + d);
            
            control = parseInt($("#ctr_desarrollo").val()) + parseInt($("#ctr_avances").val()) + parseInt($("#ctr_acc_est").val()) 
                + parseInt($("#ctr_acc_acu").val()) + parseInt($("#ctr_compromisos").val()) + parseInt($("#ctr_proc_post").val()) + parseInt($("#ctr_obj_prox_seg").val()) 
            ...
            //(a == 1) ? $("#obj_seg").addClass("error") : $("#obj_seg").removeClass("error");
            (b == 1) ? $("#desarrollo").addClass("error") : $("#desarrollo").removeClass("error");
            (c == 1) ? $("#avances").addClass("error") : $("#avances").removeClass("error");
            (d == 1) ? $("#acc_est").addClass("error") : $("#acc_est").removeClass("error");
            (e == 1) ? $("#acc_acu").addClass("error") : $("#acc_acu").removeClass("error");
            (f == 1) ? $("#compromisos").addClass("error") : $("#compromisos").removeClass("error");
            (g == 1) ? $("#proc_post").addClass("error") : $("#proc_post").removeClass("error");
            (h == 1) ? $("#obj_prox_seg").addClass("error") : $("#obj_prox_seg").removeClass("error");
            (i == 1) ? $("#fecha_prox_seg").addClass("error") : $("#fecha_prox_seg").removeClass("error");
            (j == 1) ? $("#hora_prox_seg").addClass("error") : $("#hora_prox_seg").removeClass("error");
        }
        ...
        function enviardat(des, fechareal, horareal, ava, accest, accacu, com, propost) {
            //alert (idtema);
		...
		<div id="page-wrapper">
			<div class="main-page">
				...
				<div class="forms">
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						<div class="form-body">
							<form action="php/crear_gestion_seg.php" method="POST" id="form" name="form" onsubmit="javascript:return Validar(this);"  enctype="multipart/form-data">
								...
								<div class="form-group col-lg-3"> 
                                    <label for="psi_val">Fecha programada:</label>
                                    <input type="text" class="form-control" id="fecha_prog" name="fecha_prog" readonly>
								</div>
								<div class="form-group col-lg-3"> 
                                    <label for="psi_val">Hora programada:</label>
                                    <input type="text" class="form-control" id="hora_prog" name="hora_prog" readonly>
								</div>
								...
								<div class="form-group col-lg-12"> 
									<label for="obj_seg">Objetivo seguimiento:</label> 
									<textarea id="obj_seg" name="obj_seg"  rows="4" class="form-control" readonly></textarea>
								...
								<div class="ghf">
    								...
    								<!--<div class="form-group col-lg-4">
									    <button class="btn btn-warning glyphicon glyphicon-save-file" id="btnverval" name="btnverval" style="background: #088A4B; color: #ffffff; font-size: 16px; font-weight: 300;"> Exportar valoración</button>
									</div>-->
    								...
    								<!--<div class="form-group col-lg-3">
									    <button class="btn btn-warning glyphicon glyphicon-save-file" id="btnverseg" name="btnverseg" style="background: #fcff33; color: #000000; font-size: 16px; font-weight: 300;"> Exportar seguimientos</button>
									</div>-->
    								...
    								<div class="form-group col-lg-12"> 
    									<label for="desarrollo">Desarrollo seguimiento (500 | <label class="maxl" id="lbldesarrollo">0</label>)</label> 
    									<textarea id="desarrollo" name="desarrollo"  rows="4" class="form-control1" placeholder="Desarrollo seguimiento" maxlength="500" onkeyup="mayus(this, 'desarrollo', 'Desarrollo seguimiento');" required></textarea>
    									<input type="hidden" class="textarea" style="width: 20px" id="ctr_desarrollo" value="1"/>
    								</div>
    								
    								<div class="form-group col-lg-12"> 
    									<label for="avances">Avances del proceso (500 | <label class="maxl" id="lblavances">0</label>)</label> 
    									<textarea id="avances" name="avances"  rows="4" class="form-control1" placeholder="Avances del proceso" maxlength="500" onkeyup="mayus(this, 'avances', 'Avances del proceso');" required></textarea>
    									<input type="hidden" class="textarea" style="width: 20px" id="ctr_avances" value="1"/>
    								</div>
    								
    								<div class="form-group col-lg-12"> 
    									<label for="acc_est">Acciones específicas del estudiante (500 | <label class="maxl" id="lblacc_est">0</label>)</label> 
    									<textarea id="acc_est" name="acc_est"  rows="4" class="form-control1" placeholder="Acciones específicas del estudiante" maxlength="500" onkeyup="mayus(this, 'acc_est', 'Acciones del estudiante');" required></textarea>
    									<input type="hidden" class="textarea" style="width: 20px" id="ctr_acc_est" value="1"/>
    								</div>
    								
    								<div class="form-group col-lg-12"> 
    									<label for="acc_acu">Acciones específicas del acudiente (500 | <label class="maxl" id="lblacc_acu">0</label>)</label> 
    									<textarea id="acc_acu" name="acc_acu"  rows="4" class="form-control1" placeholder="Acciones específicas del acudiente" maxlength="500" onkeyup="mayus(this, 'acc_acu', 'Acciones del acudiente');" required></textarea>
    									<input type="hidden" class="textarea" style="width: 20px" id="ctr_acc_acu" value="1"/>
    								</div>
    								
    								<div class="form-group col-lg-12"> 
    									<label for="compromisos">Copromisos por las partes (500 | <label class="maxl" id="lblcompromisos">0</label>)</label> 
    									<textarea id="compromisos" name="compromisos"  rows="4" class="form-control1" placeholder="Compromisos por las partes" maxlength="500" onkeyup="mayus(this, 'compromisos', 'Compromisos por las partes');" required></textarea>
    									<input type="hidden" class="textarea" style="width: 20px" id="ctr_compromisos" value="1"/>
    								</div>
    								
    								<div class="form-group col-lg-12"> 
    									<label for="proc_post">Procesos posteriores interinstitucionales (500 | <label class="maxl" id="lblproc_post">0</label>)</label> 
    									<textarea id="proc_post" name="proc_post"  rows="4" class="form-control1" placeholder="Procesos posteriores interinstitucionales" maxlength="500" onkeyup="mayus(this, 'proc_post', 'Procesos posteriores interinstitucionales');" required></textarea>
    									<input type="hidden" class="textarea" style="width: 20px" id="ctr_proc_post" value="1"/>
    								</div>
    								
    								<div class="form-group col-lg-12"> 
    									<label for="obj_prox_seg">Objetivo próximo seguimiento (500 | <label class="maxl" id="lblobj_prox_seg">0</label>) 
    									    <label style="color: purple;"> ... {NA -> si no hay próximo seguimiento}</label>
    									</label> 
    								...
    								<div class="form-group col-lg-9 objna">
    								    <div id='calendar'></div>
    								</div>
    								<div class="form-group col-lg-3 objna">
    								    <div class="form-group col-lg-12"> 
    ...
    <div class="modal fade" id="modal_seguimiento" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          ...
          <div class="form-group col-lg-3">
              <button class="btn btn-warning glyphicon glyphicon-save-file" id="btnverseg" name="btnverseg" style="background: #fcff33; color: #000000; font-size: 16px; font-weight: 300;"> Exportar seguimiento</button>
          </div>
