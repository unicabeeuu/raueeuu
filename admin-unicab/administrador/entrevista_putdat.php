        ...
        function buscar_inf() {
            ...
            $.ajax({
        		...
        		success:function(r) {
					...
					if(res.eval_adm == "0") {
						$("#msgdocumento").html("Debe primero programar la evaluación de admisión");
					}
					else {
						$("#msgdocumento").html("");
				...
				<div class="forms">
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						<div class="form-title">
							<h4>Agendar nueva entrevista:</h4><?php //echo $sql_emp; ?>	
						</div>
					</div>
				</div>
				<div class="forms">
					<div class="form-grids row widget-shadow azul1" data-example-id="basic-forms"> 
						...
						<div class="form-group col-lg-6 text-left azul1">
							<h4 id="msgdocumento" style="color: blue;"></h4>
						</div>
					</div>
				</div>
				<div class="forms">
